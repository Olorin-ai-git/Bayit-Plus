# Station-AI - Design System

A comprehensive guide to the visual design, components, and styling standards for the Station-AI application.
...
The Station-AI uses a **dark-first glassmorphism design** with a red accent color derived from the brand logo. The design system emphasizes:
