...
class Settings(BaseSettings):
    ...
    mongodb_db_name: str = Field(default="israeli_radio")  # Renamed from mongodb_db to match olorin-shared
    ...
    cors_allowed_origins: str = Field(
        default="https://station.olorin.ai,https://marketing.station.olorin.ai"
