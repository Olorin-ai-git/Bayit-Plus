...
class BackendProxyService {
  ...
  // ============================================
  // Wake Word Detection Proxy (Optional on tvOS)
  // ============================================

  /**
   * Detect wake word in audio file using backend proxy
   * NOTE: Wake word detection is optional on tvOS. Menu button is primary trigger.
  ...
  // ============================================
  // Voice Command Processing (tvOS-optimized)
  // ============================================

  /**
   * Process voice command (transcription → action)
   * Sends user's spoken command to backend for processing
   * TV-optimized: handles 10-foot UI commands, multi-window controls
