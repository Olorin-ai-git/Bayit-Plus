...
const PodcastCard: React.FC<{
  ...
  return (
    ...
    >
      <Animated.View
        className={`bg-[#1a1525] rounded-lg overflow-hidden border-[3px] ${isFocused ? 'border-green-500' : 'border-transparent'}`}
  ...
  return (
    <View className="flex-1 bg-[#0a0a1a]">
      ...
      <FlatList
        ...
        numColumns={isTV ? 5 : 3}
        key={isTV ? 'tv' : 'mobile'}
        contentContainerStyle={{ paddingHorizontal: 32, paddingBottom: 48, paddingTop: 16, direction: 'ltr' }}
