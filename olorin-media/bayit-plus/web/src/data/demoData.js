...
export const demoChannels = [
  ...
  },
  {
    id: 'channel-kids',
    name: 'ערוץ הילדים',
    name_en: 'Kids Channel',
    name_es: 'Canal Infantil',
    description: 'ערוץ בתוכניות לילדים',
    description_en: 'Children\'s programming channel',
    description_es: 'Canal de programación infantil',
    logo: 'https://picsum.photos/seed/kids/200/200',
    thumbnail: 'https://picsum.photos/seed/kids-thumb/400/225',
    stream_url: 'https://test-streams.mux.dev/x36xhzz/x36xhzz.m3u8',
    category: 'kids',
    is_active: true,
    current_show: 'טיטו וחבריו',
    next_show: 'קטטו וילדיו',
  },
  {
    id: 'channel-music',
    name: 'מיוזיק בוקס',
    name_en: 'Music Box',
    name_es: 'Caja de Música',
    description: 'ערוץ מוזיקה וקליפים',
    description_en: 'Music and video clips channel',
    description_es: 'Canal de música y videoclips',
    logo: 'https://picsum.photos/seed/music/200/200',
    thumbnail: 'https://picsum.photos/seed/music-thumb/400/225',
    stream_url: 'https://test-streams.mux.dev/x36xhzz/x36xhzz.m3u8',
    category: 'music',
    is_active: true,
    current_show: 'הקליפים הטובים',
    next_show: 'מחזור הזהב',
  },
];
...
export const demoRadioStations = [
  ...
  },
  {
    ...
    name: 'רדיו דיבור',
    name_en: 'Talk Radio',
    name_es: 'Radio Hablada',
    description: 'רדיו דיבור - שיחות ודיון',
    description_en: 'Talk radio - conversations and discussion',
    description_es: 'Radio hablada - conversaciones y discusión',
    logo: 'https://picsum.photos/seed/talkradio/200/200',
    stream_url: 'https://test-streams.mux.dev/x36xhzz/audio.m3u8',
    genre: 'talk',
    is_active: true,
    current_show: 'שיחה עם דברים',
  },
  {
    id: 'radio-jewish',
    name: 'רדיו יהודי',
    name_en: 'Jewish Radio',
    name_es: 'Radio Judía',
    description: 'תחנה יהודית - תוכנים דתיים וקהילתיים',
    description_en: 'Jewish station - religious and community programming',
    description_es: 'Estación judía - programación religiosa y comunitaria',
    logo: 'https://picsum.photos/seed/jewish-radio/200/200',
    stream_url: 'https://test-streams.mux.dev/x36xhzz/audio.m3u8',
    genre: 'jewish',
    is_active: true,
    current_show: 'שיעור יומי',
  },
];
