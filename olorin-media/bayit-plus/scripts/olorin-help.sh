...
${BOLD}${CYAN}ADVANCED COMMANDS (Coming in Phase 2):${NC}
  ${YELLOW}agent${NC} <name>         Invoke Claude agents (Phase 2)
  ${YELLOW}skill${NC} <name>         Execute skills (Phase 2)
  ${YELLOW}deploy${NC} <target>      Deploy to staging/production (Phase 2)
  ${YELLOW}config${NC}               Manage configuration (Phase 2)
