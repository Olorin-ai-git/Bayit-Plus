        ...
        <div className="ml-3 flex-1">
          ...
          {onRetry && (
            <div className="mt-4">
              <button
                type="button"
                className={`inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md ${styles.button} bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2`}
                onClick={onRetry}
              >
          ...
          {details && (
            <div className="mt-3">
              <button
                type="button"
                className={`text-sm underline ${styles.button} font-medium`}
