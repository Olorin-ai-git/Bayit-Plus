...
import { InvestigationResults, AgentResult, Evidence, Investigation } from '../types/investigation';
...
export const ResultsVisualization: React.FC<ResultsVisualizationProps> = ({
  ...
  const riskAnalysis: RiskAnalysis = useMemo(() => {
    ...
    return {
      overallRisk: results.riskScore * 100,
      ...
      {!results ? (
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">
                Confidence: <span className={`font-medium ${getConfidenceColor(results.confidence * 100)}`}>
          ...
          <div className="lg:col-span-2 bg-white rounded-lg border border-gray-200 p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <h4 className="text-sm font-medium text-gray-700 mb-2">Key Findings ({results.findings.length})</h4>
                  <ul className="space-y-1">
                    ...
                    {results.findings.length > 3 && (
                      <li className="text-sm text-blue-600">
                        +{results.findings.length - 3} more findings
                      </li>
                    )}
                  </ul>
                </div>
                ...
                <div>
                  <h4 className="text-sm font-medium text-gray-700 mb-2">Recommendations ({results.recommendations.length})</h4>
                  <ul className="space-y-1">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            ...
            <div className="relative">
              {/* Timeline chart would go here - simplified version */}
