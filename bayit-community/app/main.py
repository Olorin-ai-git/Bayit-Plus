"""
Bayit+ Community Service.

Extracted Cloud Run service for community routes. Connects to the same
MongoDB cluster and Redis instance as the monolith, but handles only
community endpoints (Judaism, news, Jerusalem, Tel Aviv, cultures,
support, widgets, trivia, feature validation, onboarding) with
...
SERVICE_TITLE = "Bayit+ Community Service"
