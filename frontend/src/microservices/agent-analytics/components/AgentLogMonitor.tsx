...
interface AgentLogMonitorProps {
  isOpen: boolean;
  onClose: () => void;
  logs: LogEntry[];
  onClearLogs: () => void;
...
const AgentLogMonitor: React.FC<AgentLogMonitorProps> = ({
  isOpen,
  onClose,
  logs,
  onClearLogs,
      ...
      >
        {visibleLogs.length === 0 ? (
          <div className="text-center py-8 text-gray-500">
            ...
            <p>No activity logs yet. Agent activity will appear here.</p>
          </div>
        ) : (
...
export default AgentLogMonitor;