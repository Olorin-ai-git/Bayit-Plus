...
class HTTPRequestTool(BaseTool):
    ...
    def __init__(self, user_agent: Optional[str] = None, default_headers: Optional[Dict[str, str]] = None, **kwargs):
    ...
    async def _arun(
        ...
        return self._run(url, method, headers, params, data, json_data, timeout, follow_redirects)
...
class JSONAPITool(BaseTool):
    ...
    async def _arun(
        ...
        return self._run(url, method, data, params, auth_token, api_key, api_key_header, timeout) 