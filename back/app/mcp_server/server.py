...
from ..service.agent.tools.tool_registry import initialize_tools, get_tools_for_agent, tool_registry
        ...
        async def read_resource(uri: str) -> str:
            ...
            try:
                if uri == "olorin://tools/summary":
                    ...
                    for key in ['openai_api_key', 'langfuse_api_key', 'database_connection_string']:
