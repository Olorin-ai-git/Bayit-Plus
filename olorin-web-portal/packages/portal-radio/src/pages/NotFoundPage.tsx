      ...
      <div className="wizard-container">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button
              onClick={() => navigate('/')}
              className="bg-transparent border-2 border-wizard-accent-purple text-wizard-accent-purple hover:bg-wizard-accent-purple/20 hover:shadow-glow-purple transition-all duration-300 rounded-lg font-semibold px-6 py-3 flex items-center justify-center space-x-2"
            >
          ...
          <div className="mt-16 pt-8 border-t border-wizard-border-secondary">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <button
                onClick={() => navigate('/')}
                className="text-wizard-accent-purple hover:underline"
              >
                Home
              </button>
