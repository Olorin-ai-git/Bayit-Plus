...
export class FeatureRegistryAdapter implements IFeatureRegistry {
  ...
  registerFeature(feature: Feature): void {
    logger.warn('registerFeature not implemented in FeatureRegistryAdapter - features are statically defined');
    // Note: Dynamic feature registration is needed, implement here
  }
