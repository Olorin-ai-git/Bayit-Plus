...
export class SectionGenerators {
  ...
  static generateFeaturePreviews(
    ...
    logger.warn('🔍 [FEATURE PREVIEW GENERATION] Processing features:', features);
    logger.warn('🔍 [FEATURE PREVIEW GENERATION] Selected features:', selectedFeatures);
    ...
    return features
      .map(featureId => {
        ...
        logger.warn(`🔍 [FEATURE PREVIEW] Feature: ${featureId}, CamelCase: ${camelCaseKey}, Enabled: ${isEnabled}`);
