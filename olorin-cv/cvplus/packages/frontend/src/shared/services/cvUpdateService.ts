...
export class CVUpdateService {
  ...
  static async updatePersonalInfo(
    ...
    try {
      ...
      logger.error('Personal info update failed:', error);
      return {
        success: false,
  ...
  static async updateCVData(
    ...
    try {
      ...
      logger.error('CV data update failed:', error);
      return {
        success: false,
  ...
  static async updatePlaceholder(request: PlaceholderUpdateRequest): Promise<PlaceholderUpdateResponse> {
    try {
      ...
      logger.error('Placeholder update failed:', error);
      return {
        success: false,
        error: error instanceof Error ? error.message : 'Unknown error',
        errorDetails: {
  ...
  static async updatePlaceholdersBatch(
    ...
    try {
      ...
      logger.error('Batch placeholder update failed:', error);
      return {
        success: false,
        results,
