...
export class ProfileService {
  ...
  async getAccessControls(profileId: string): Promise<AccessControl[]> {
    try {
      ...
      logger.error('Error fetching access controls:', error);
  ...
  async mapCustomDomain(
    ...
    try {
      ...
      logger.error('Error mapping custom domain:', error);
  ...
  async saveProfileVersion(
    ...
    try {
      ...
      logger.error('Error saving profile version:', error);
  ...
  async getProfileVersions(profileId: string): Promise<ProfileVersion[]> {
    try {
      ...
      logger.error('Error fetching profile versions:', error);
