...
import { useKeyboardShortcuts } from '../../shared/utils/cv-preview/keyboardShortcuts';
...
// Stub components
const CVPreviewToolbar = () => null;
const CVPreviewContent = () => null;
const CVComparisonView = () => null;
const SectionEditor = () => null;
const QRCodeEditor = () => null;
