...
export const runwaymlStatusCheck = onRequest(
  ...
  async (request, response) => {
    ...
    try {
      ...
      logger.info(`[RunwayML Status Check] Status retrieved in ${processingTime}ms:`, {
        jobId: status.jobId,
      ...
      logger.error('[RunwayML Status Check] Failed:', {
        error: error.message,
...
export const runwaymlBatchStatusCheck = onRequest(
  ...
  async (request, response) => {
    ...
    try {
      ...
      logger.info(`[RunwayML Batch Status Check] Completed in ${processingTime}ms:`, {
        total: jobIds.length,
      ...
      logger.error('[RunwayML Batch Status Check] Failed:', {
        error: error.message,
        processingTime
      });
...
export const runwaymlPollingTask = onTaskDispatched(
  ...
  async (request) => {
    ...
    try {
      ...
      logger.info(`[RunwayML Polling Task] Completed in ${processingTime}ms:`, {
        jobId,
        status: status.status,
        progress: status.progress,
      ...
      logger.error('[RunwayML Polling Task] Failed:', {
        error: error.message,
...
export const runwaymlCleanupTask = onTaskDispatched(
  ...
  async (request) => {
    ...
    try {
      ...
      logger.info(`[RunwayML Cleanup Task] Completed in ${processingTime}ms:`, {
      ...
      logger.error('[RunwayML Cleanup Task] Failed:', {
        error: error.message,
        processingTime
      });
