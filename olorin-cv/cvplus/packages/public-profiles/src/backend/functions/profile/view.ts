...
export const viewPublicProfile = onRequest(
  ...
  async (req: Request, res: Response) => {
    try {
      logger.info('Public profile view request received');
      ...
      logger.info(`Viewing public profile: ${profileIdentifier}`);
      ...
      logger.info(`Public profile viewed successfully: ${profile.slug}`);
