...
export const createPublicProfile = onRequest(
  ...
  async (req: Request, res: Response) => {
    try {
      logger.info('Public profile creation request received');
      ...
      logger.info(`Creating public profile for CV: ${requestData.cvId}, user: ${userId}`);
      ...
      logger.info(`Public profile created successfully: ${createdProfile.id}`);
      ...
      logger.error('Public profile creation error:', error);
