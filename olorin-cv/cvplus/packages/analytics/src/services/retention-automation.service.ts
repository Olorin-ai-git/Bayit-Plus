  ...
  */
  ...
  private async sendPersonalizedEmail(params: {
    ...
    try {
      ...
      logger.error('Failed to queue personalized email:', error);
      return false;
    }
  }
  ...
  private async createDiscountOffer(params: {
    ...
    try {
      ...
      logger.error('Failed to create discount offer:', error);
      return false;
    }
  }
  ...
  private async createPersonalizedTutorial(params: {
    ...
    try {
      ...
      logger.error('Failed to create personalized tutorial:', error);
      return false;
    }
  }
