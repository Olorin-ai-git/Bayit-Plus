...
export class AlertManagerService {
  ...
  */
  ...
  private async switchProvider(parameters: any): Promise<boolean> {
    try {
      logger.info('Executing provider switch with parameters:', parameters);
  ...
  private async throttleRequests(parameters: any): Promise<boolean> {
    try {
      logger.info('Executing request throttling with parameters:', parameters);
      ...
      logger.error('Failed to throttle requests:', error);
      return false;
    }
  }
  ...
  private async restartService(parameters: any): Promise<boolean> {
    try {
      logger.info('Executing service restart with parameters:', parameters);
