...
class TestBooleanQueryParser:
    ...
    def test_simple_not_operation(self):
        ...
        parser = BooleanQueryParser(
            expression="NOT user123", entity_mapping={"user123": "user123"}
        )
    ...
    def test_complex_nested_queries(self):
        ...
        result = parser.evaluate(
            {"user123": True, "transaction456": False, "store789": True}
        )
        assert result is True

        # Test (False AND False) OR False = False
        result = parser.evaluate(
            {"user123": False, "transaction456": False, "store789": False}
        )
        assert result is False

        # Test (True AND True) OR False = True
        result = parser.evaluate(
            {"user123": True, "transaction456": True, "store789": False}
        )
        assert result is True
    ...
    def test_parentheses_grouping(self):
        ...
        result = parser.evaluate(
            {"user123": True, "transaction456": False, "store789": False}
        )
        assert result is False
    ...
    def test_empty_expression_handling(self):
        ...
        parser = BooleanQueryParser(expression="", entity_mapping={})
    ...
    def test_single_entity_expression(self):
        ...
        parser = BooleanQueryParser(
            expression="user123", entity_mapping={"user123": "user123"}
        )
...
class TestBooleanQueryEdgeCases:
    ...
    def test_operator_at_start(self):
        ...
        parser = BooleanQueryParser(
            expression="AND user123", entity_mapping={"user123": "user123"}
        )
    ...
    def test_operator_at_end(self):
        ...
        parser = BooleanQueryParser(
            expression="user123 AND", entity_mapping={"user123": "user123"}
        )
    ...
    def test_special_characters_in_entity_names(self):
        ...
        parser = BooleanQueryParser(
            ...
            entity_mapping={
                "user_123": "user_123",
                "transaction_456": "transaction_456",
            },
        )
