...
class AlwaysFailsTool(BaseTool):
    ...
    def _run(self, query: str = "") -> str:
        raise ConnectionError(
            "Cannot connect to host ipscache-qal.api.olorin.com:443 ssl:default [nodename nor servname provided, or not known]"
        )
...
async def main():
    ...
    try:
        ...
        print(
            f"Bulletproof System Status: {'✅ WORKING' if is_working else '❌ FAILED'}"
        )
