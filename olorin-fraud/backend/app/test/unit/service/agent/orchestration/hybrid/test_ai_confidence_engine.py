...
class TestAIConfidenceEngine:
    ...
    @pytest.mark.asyncio
    async def test_calculate_investigation_confidence_basic(
        self, confidence_engine, mock_state
    ):
        """Test basic confidence calculation"""

        # Act
        decision = await confidence_engine.calculate_investigation_confidence(
            mock_state
        )
    ...
    @pytest.mark.asyncio
    async def test_assess_snowflake_evidence_with_data(
        self, confidence_engine, mock_state
    ):
        ...
        assert (
            confidence > 0.5
        )  # Should be high due to rich data and high fraud probability
    ...
    @pytest.mark.asyncio
    async def test_assess_domain_evidence_with_domains(
        self, confidence_engine, mock_state
    ):
    ...
    @pytest.mark.asyncio
    async def test_determine_investigation_strategy_critical_path(
        self, confidence_engine, mock_state
    ):
        """Test strategy determination for critical path"""

        # Act
        strategy = await confidence_engine._determine_investigation_strategy(
            mock_state, 0.95
        )
    ...
    @pytest.mark.asyncio
    async def test_determine_investigation_strategy_minimal(
        self, confidence_engine, mock_state
    ):
    ...
    @pytest.mark.asyncio
    async def test_determine_investigation_strategy_comprehensive(
        self, confidence_engine, mock_state
    ):
    ...
    @pytest.mark.asyncio
    async def test_determine_next_action_snowflake_incomplete(
        self, confidence_engine, mock_state
    ):
    ...
    @pytest.mark.asyncio
    async def test_determine_next_action_critical_path(
        self, confidence_engine, mock_state
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_priority_domains_with_network_anomalies(
        self, confidence_engine, mock_state
    ):
    ...
    @pytest.mark.asyncio
    async def test_determine_agents_to_activate_critical_path(
        self, confidence_engine, mock_state
    ):
    ...
    @pytest.mark.asyncio
    async def test_determine_agents_to_activate_comprehensive(
        self, confidence_engine, mock_state
    ):
    ...
    @pytest.mark.asyncio
    async def test_determine_recommended_tools_critical_path(
        self, confidence_engine, mock_state
    ):
    ...
    @pytest.mark.asyncio
    async def test_determine_recommended_tools_minimal(
        self, confidence_engine, mock_state
    ):
    ...
    @pytest.mark.asyncio
    async def test_calculate_investigation_completeness(
        self, confidence_engine, mock_state
    ):
        ...
        # Act
        completeness = await confidence_engine._calculate_investigation_completeness(
            mock_state
        )
