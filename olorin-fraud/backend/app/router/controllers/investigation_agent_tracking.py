...
async def log_agent_pre_execution(investigation_id: str, investigation_query: str):
    ...
    structured_investigation_logger.log_llm_interaction(
        ...
        tokens_used={
            "prompt_tokens": len(investigation_query.split()) * 1.3,
            "completion_tokens": 0,
            "total_tokens": len(investigation_query.split()) * 1.3,
        },
        tools_available=[
            "device_analysis",
            "location_analysis",
    ...
    journey_tracker.track_node_execution(
        ...
        input_state={
            "device_data": "loaded",
            "historical_patterns": "available",
            "fingerprint_inconsistencies": True,
        },
        output_state={
            "device_analysis": "in_progress",
            "spoofing_indicators": "detected",
        },
        duration_ms=0,
        status=NodeStatus.IN_PROGRESS,
        agent_name="DeviceAnalysisAgent",
        metadata={
            "analysis_type": "device_fingerprinting",
            "risk_level": "high",
            "confidence": 95.0,
        },
    )
...
async def log_agent_successful_execution(
...
async def log_langgraph_nodes(
    ...
    structured_investigation_logger.log_langgraph_node(
        ...
        state_after={
            **base_state_before,
            "device_analysis_completed": True,
            "location_analysis_completed": True,
        },
        execution_result={
    ...
    structured_investigation_logger.log_langgraph_node(
        ...
        state_after={
            **base_state_before,
            "device_analysis_completed": True,
            "location_analysis_completed": True,
            "network_analysis_completed": True,
        },
