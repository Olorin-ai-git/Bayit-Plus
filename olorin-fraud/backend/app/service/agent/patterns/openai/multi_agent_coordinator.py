    ...
    def __init__(self, openai_client, tools, ws_streaming=None):
        ...
        self.domain_agents = {
            "network": {
                ...
                "specialization": "IP analysis, VPN/proxy detection, network patterns",
            },
            "device": {
                "name": "Device Analysis Agent",
                "specialization": "Device fingerprinting, browser analysis, hardware patterns",
            },
            "location": {
                "name": "Location Analysis Agent",
                "specialization": "Geographic analysis, timezone validation, location patterns",
            },
            "logs": {
                "name": "Logs Analysis Agent",
                "specialization": "Event log analysis, behavioral patterns, anomaly detection",
            },
        }
...
class HandoffManager:
    ...
    async def create_handoff_context(
        self, from_agent: str, to_agent: str, investigation_data: Dict[str, Any]
    ) -> Dict[str, Any]:
    ...
    def _identify_priority_areas(
        self, from_agent: str, data: Dict[str, Any]
    ) -> List[str]:
