...
class ActionPlanner:
    ...
    async def determine_next_action(
        ...
        next_action = await self._route_by_strategy(
            strategy, state, current_phase, domains_completed
        )
    ...
    async def _route_focused(
        self, state: HybridInvestigationState, domains_completed: List[str]
    ) -> str:
