...
class LangfuseTracer:
    ...
    def __init__(
        ...
        self.secret_key = secret_key or os.getenv(
            "LANGFUSE_SECRET_KEY", "sk-lf-dae99134-c97c-41ef-b98a-b88861d66fdd"
        )
        self.public_key = public_key or os.getenv(
            "LANGFUSE_PUBLIC_KEY", "pk-lf-0c1b17de-e7c1-43a1-bc05-e15231c5d00a"
        )
        ...
        if Langfuse is None:
            ...
            if LangfuseCallbackHandler is None:
                logger.warning(
                    "⚠️ Langfuse CallbackHandler not available - callback tracing disabled"
                )
                self.callback_handler = None
            else:
    ...
    def create_traced_config(
        ...
        if LangfuseCallbackHandler is None:
            logger.debug(
                "Langfuse CallbackHandler not available - skipping callback registration"
            )
        else:
        ...
        def decorator(func):
            ...
            async def async_wrapper(*args, **kwargs):
                ...
                try:
                    ...
                    span.update(output={"status": "success"}, level="INFO")
    ...
    def log_tool_usage(
        ...
        self.langfuse.generation(
            ...
            input=input_data,
            output=output_data,
            metadata={"tool_name": tool_name, "duration_ms": duration * 1000},
            level="INFO",
        )
        self.langfuse.flush()
