...
class ThreatIntelConfig:
    ...
    def __init__(self):
        ...
        self.virustotal_paid_plan = (
            os.getenv("VIRUSTOTAL_PAID_PLAN", "false").lower() == "true"
        )
        self.abuseipdb_paid_plan = (
            os.getenv("ABUSEIPDB_PAID_PLAN", "false").lower() == "true"
        )
        ...
        self.enable_rate_limiting = (
            os.getenv("THREAT_INTEL_RATE_LIMITING", "true").lower() == "true"
        )
    ...
    def get_mock_response(
        self, provider: str, endpoint: str, entity: str
    ) -> Dict[str, Any]:
