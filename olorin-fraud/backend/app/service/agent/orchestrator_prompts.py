...
class OrchestratorPromptSystem:
    ...
    def generate_orchestration_prompt(
        self, context: PromptContext, strategy_hint: Optional[PromptStrategy] = None
    ) -> str:
        """
    ...
    def _apply_context_integration(
        self, template: str, context: PromptContext, strategy: PromptStrategy
    ) -> str:
    ...
    def _add_bulletproof_instructions(self, prompt: str, context: PromptContext) -> str:
