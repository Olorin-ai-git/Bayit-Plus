...
def update_rag_stats_on_success(rag_stats: Dict[str, Any]) -> Dict[str, Any]:
    ...
    rag_stats["domain_knowledge_categories"] = (
        8  # risk_scoring_models, fraud_risk_indicators, behavioral_risk_analysis, financial_risk_patterns, account_risk_assessment, transaction_risk_analysis, risk_correlation_techniques, regulatory_compliance_risk
    )
    return rag_stats


def create_risk_agent_metadata(
