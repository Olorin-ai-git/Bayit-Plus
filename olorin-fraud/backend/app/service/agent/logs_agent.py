...
async def structured_logs_agent(state, config) -> dict:
    ...
    from .logs_agent_config import (
        create_logs_agent_metadata,
        create_logs_rag_config,
        get_logs_objectives,
    ...
    journey_tracker.track_node_execution(
        ...
        input_state={
            "entity_id": entity_id,
            "logs_analysis": "starting",
            "investigation_phase": "logs_domain",
            "rag_enabled": RAG_AVAILABLE,
        },
        output_state={
            "logs_analysis": "in_progress",
            "agent_status": "active",
    ...
    try:
        ...
        if RAG_AVAILABLE and rag_config:
            ...
            logger.info(
                "📄 Created logs agent with intelligent RAG-enhanced tool selection"
            )
        else:
        ...
        logs_objectives = get_logs_objectives(
        ...
        completion_metadata = create_logs_agent_metadata(
        ...
        journey_tracker.track_node_execution(
            ...
            agent_name=(
                "RAG-Enhanced-LogsAgent" if RAG_AVAILABLE else "StructuredLogsAgent"
            ),
