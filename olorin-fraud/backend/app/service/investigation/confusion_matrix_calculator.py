...
def calculate_confusion_matrix_for_investigation(
    investigation_id: str, by_merchant: bool = True
) -> Dict[str, Any]:
    """
    ...
    return calculate_confusion_matrix_14day(
        investigation_id=investigation_id, by_merchant=by_merchant
    )


def calculate_confusion_matrix_for_entity(
    entity_type: str, entity_id: str, by_merchant: bool = True
) -> Dict[str, Any]:
    """
    ...
    """
    return calculate_confusion_matrix_14day(
        entity_type=entity_type, entity_id=entity_id, by_merchant=by_merchant
    )
