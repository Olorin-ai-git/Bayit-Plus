...
class AgentInstrumentationHelper:
    ...
    def create_instrumented_tool(self, tool_name: str, tool_func: Callable) -> Callable:
...
def create_agent_instrumentor(
    agent_name: str, investigation_id: str
) -> AgentInstrumentationHelper:
