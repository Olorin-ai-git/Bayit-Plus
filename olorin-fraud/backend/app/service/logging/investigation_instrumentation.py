...
class InvestigationInstrumentationLogger:
    ...
    def log_risk_calculation(
        ...
        self.writer.write_entry(
            EntityType.RISK_CALCULATION.value, calculation.to_dict()
        )
...
def get_investigation_logger(
    investigation_id: str,
) -> InvestigationInstrumentationLogger:
    """Get or create investigation instrumentation logger"""
    global _instrumentation_logger
    if (
        _instrumentation_logger is None
        or _instrumentation_logger.investigation_id != investigation_id
    ):
        log_dir = os.getenv("INVESTIGATION_LOG_DIR", "./investigation_logs")
        _instrumentation_logger = InvestigationInstrumentationLogger(
            investigation_id, log_dir
        )
