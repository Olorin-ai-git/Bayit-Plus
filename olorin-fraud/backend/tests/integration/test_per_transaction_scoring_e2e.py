...
class TestPerTransactionScoringE2E:
    ...
    def test_full_flow_calculation_to_confusion_matrix(self):
        ...
        domain_findings = {
            ...
            "device": {
                "device_risks": {"device_1": 0.7, "device_2": 0.5, "device_3": 0.3},
                "risk_score": 0.5,
                "confidence": 0.8,
            },
        ...
        progress = InvestigationProgress(transaction_scores=transaction_scores)
        ...
        with (
            ...
            assert (
                len(set(scores)) > 1
            ), "All transactions should not have the same score"
