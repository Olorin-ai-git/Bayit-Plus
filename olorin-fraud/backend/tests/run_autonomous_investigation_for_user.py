...
print(f"\n🚀 Starting Structured Investigation for {entity_type}: {entity_id}")
print("=" * 60)
...
if not os.path.exists("DejaVuSans.ttf"):
    ...
    pdf.cell(0, 15, "Structured Investigation Report", ln=1, align="C")
    pdf.ln(5)
    ...
    pdf.cell(
        0,
        5,
        "Structured Investigation System - Real-time Fraud Detection",
        ln=1,
        align="C",
    )

    pdf_filename = f"structured_investigation_user_{entity_id}.pdf"
