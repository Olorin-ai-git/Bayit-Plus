...
class InvestigationFixApplicator:
    ...
    def apply_all_fixes(self) -> Dict[str, Any]:
        ...
        try:
            ...
            critical_fixes = [
                "langsmith_disabled",
                "websocket_auth_added",
                "schema_validation_unified",
            ]
            ...
            if results["success"]:
                ...
                print(
                    f"❌ Some fixes failed to apply. Errors: {len(results['errors'])}"
                )
    ...
    def _apply_langsmith_fix(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": False, "errors": [f"LangSmith fix not available: {e}"]}
        except Exception as e:
            return {"success": False, "errors": [f"Error applying LangSmith fix: {e}"]}
    ...
    def _apply_websocket_auth_fix(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if not test_token:
                return {"success": False, "errors": ["Failed to generate JWT token"]}
    ...
    def _apply_schema_validation_fix(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if json_result.risk_level == 0 or text_result.risk_level == 0:
                return {"success": False, "errors": ["Schema validation tests failed"]}
    ...
    def _apply_tool_validation_fix(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if not ip_valid or not domain_valid:
                return {"success": False, "errors": ["Tool validation tests failed"]}
    ...
    def _update_test_runner(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": False, "errors": [f"Error updating test runner: {e}"]}
...
"""
        ...
        updated_content = re.sub(import_pattern, r"\1" + fix_imports, content)
...
"""
        ...
        updated_content = re.sub(
            main_pattern, r"\1" + fixes_code + r"\3", content, flags=re.DOTALL
        )
