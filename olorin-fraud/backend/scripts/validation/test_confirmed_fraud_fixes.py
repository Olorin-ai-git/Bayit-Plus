...
from app.service.agent.orchestration.hybrid.canonical_outcome import (
    CanonicalOutcomeBuilder,
)
...
def test_evidence_gate_still_works():
    ...
    try:
        ...
        if risk_score is not None:
            print(
                f"   ⚠️  WARNING: Expected evidence gate to block, but risk published: {risk_score}"
            )
