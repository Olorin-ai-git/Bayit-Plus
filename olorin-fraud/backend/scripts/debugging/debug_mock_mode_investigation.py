...
async def debug_mock_investigation():
    ...
    try:
        ...
        print(
            f"✅ Successful domains ({len(successful_domains)}): {successful_domains}"
        )
        ...
        if failed_domains:
            ...
            print(
                "   3. Enhanced validation should accept partial domains in mock mode"
            )
        else:
