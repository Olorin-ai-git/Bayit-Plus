...
def test_component_count():
    ...
    for component_dir, expected_count in expected_components.items():
        dir_path = f"{base_path}/migration/{component_dir}" if component_dir != "integration" else f"{base_path}/integration"
        ...
        if actual_count == expected_count:
            print(f"✅ {component_dir}: {actual_count} components (expected {expected_count})")
        else:
            print(f"⚠️ {component_dir}: {actual_count} components (expected {expected_count})")
            all_pass = False
