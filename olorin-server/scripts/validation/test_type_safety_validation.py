...
class TestConfidencePayloadValidation:
    ...
    @pytest.mark.skipif(
        not confidence_imports_available, reason="Confidence imports not available"
    )
    ...
    def test_string_conversion(self):
        ...
        string_data = {"snowflake_score": "0.8", "tool_score": "0.7"}
    ...
    def test_to_confidence_dict_conversion(self):
        ...
        payload = ConfidencePayload(
            snowflake_score=0.8, tool_score=0.7, domain_score=0.6
        )
...
class TestAIDecisionPayloadValidation:
    ...
    @pytest.mark.skipif(
        not ai_decision_imports_available, reason="AI decision imports not available"
    )
...
def run_manual_tests():
    ...
    if confidence_imports_available:
        ...
        try:
            ...
            print(
                f"   Safe calculation result: {confidence:.3f}, issues: {len(issues)}"
            )
        except Exception as e:
