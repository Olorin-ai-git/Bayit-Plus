...
class ParameterGridGenerator:
    ...
    def __init__(self):
        ...
        # Focus on best performing prompt versions for realistic training time
        self._prompt_versions = ["v13", "v14", "v15"]  # Best 3 versions
        self._baseline_scores = [0.25, 0.35]  # 2 baselines
