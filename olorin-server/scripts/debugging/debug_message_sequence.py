    ...
    try:
        ...
        try:
            ...
            if "tool_use_id" in str(e) and "tool_result" in str(e):
                ...
                print(
                    "   3. Ensure tool_result.tool_call_id matches tool_use.id exactly"
                )
                ...
                return {
                    ...
                    "problematic_tool_id": (
                        problematic_tool_id
                        if "problematic_tool_id" in locals()
                        else None
                    ),
                }
        ...
        return {
            "success": False,
            "error": "No error caught - investigation completed unexpectedly",
        }
