...
from app.service.logging.server_log_capture import get_server_log_capture, capture_server_logs
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        if server_logs_file and server_logs_file.exists():
            ...
            with open(server_logs_file, 'r') as f:
                content = f.read()
                if "test INFO log message" in content and "test WARNING log message" in content:
