...
async def main():
    """Main entry point."""
    if len(sys.argv) < 2:
        print("Usage: python scripts/generate_package_for_investigation.py <investigation_id>")
        print("\nExample:")
        print("  python scripts/generate_package_for_investigation.py auto-comp-ee88621fd85b")
        sys.exit(1)
