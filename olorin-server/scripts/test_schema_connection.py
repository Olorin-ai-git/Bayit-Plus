    ...
    try:
        ...
        try:
            ...
            if priv_results and len(priv_results) > 0:
                ...
                print(f"   ⚠️  No explicit privileges found (may have inherited privileges)")
        except Exception as e:
        ...
        try:
            ...
            if "does not exist or not authorized" in error_msg or "02000" in error_msg:
                ...
                print(f"   💡 This indicates the schema doesn't exist or user lacks USAGE privilege")
            else:
        ...
        try:
                ...
                try:
                    ...
                    if available_tables:
                        ...
                        for row in available_tables:
                            print(f"      - {row.get('TABLE_NAME')} ({row.get('TABLE_TYPE')})")
                    else:
            ...
            error_msg = str(e)
            if "does not exist or not authorized" in error_msg or "02000" in error_msg:
                print(f"   ❌ Schema authorization error when checking table: {error_msg}")
            else:
        ...
        try:
            ...
            if "does not exist or not authorized" in error_msg or "02000" in error_msg:
                ...
                print(f"      2. User lacks USAGE privilege on schema '{full_schema}', OR")
            ...
            try:
                ...
                if test_results:
                    ...
                    try:
                        ...
                        """
                        col_results = await client.execute_query(col_query)
                        col_count = col_results[0].get('COLUMN_COUNT', 0) if col_results else 0
                        print(f"   ✅ Accessible! Row count: {row_count}, Columns: {col_count}")
                    except:
