        ...
        with get_db_session() as db:
            ...
            for txn in transactions_with_ip:
                ...
                if score_data:
                    ...
                    ip_country = score_data.get("geolocation", {}).get("country", {}).get("code")
                    ip_geo_risk = (
                        merchant_country and ip_country and
                        merchant_country != ip_country
                    )
            ...
            db.commit()
            logger.info(f"IP enrichment complete: {enriched_count}/{len(transactions_with_ip)} transactions enriched")
