...
class TestDataGenerator:
    ...
    def create_real_device_data(self, user_id: str) -> Dict[str, Any]:
        ...
        device_data = {
            ...
            "session_data": {
                ...
                "session_start": (datetime.now(timezone.utc) - timedelta(minutes=30)).isoformat(),
            ...
            "network_analysis": {
                ...
                "ip_history": [
                    ...
                    },
                    {
                        ...
                        "last_seen": (datetime.now(timezone.utc) - timedelta(days=2)).isoformat(),
                        "usage_count": 23,
                        "location": "New York, NY, US"
                    }
                ],
    ...
    def generate_comprehensive_test_data(self) -> RealTestData:
        ...
        agent_context = self.create_real_agent_context(user_id, investigation_id, entity_id)
    ...
    def create_test_investigation_variants(self, count: int = 5) -> List[Dict[str, Any]]:
        ...
        for record_type, record_id in self.created_records:
            try:
                if record_type == "investigation":
                    record = self.db_session.query(InvestigationRecord).filter(
                        InvestigationRecord.investigation_id == record_id
                    ).first()
