...
class TestRegistryPerformance:
    ...
    def test_query_by_entity_performance(self):
        ...
        assert elapsed < 0.05, f"Query took too long: {elapsed*1000:.2f}ms (target: <50ms)"
    ...
    def test_query_by_date_range_performance(self):
        ...
        assert elapsed < 0.05, f"Date range query took too long: {elapsed*1000:.2f}ms (target: <50ms)"
    ...
    def test_full_text_search_performance(self):
        ...
        assert elapsed < 0.1, f"Full-text search took too long: {elapsed*1000:.2f}ms (target: <100ms)"
    ...
    def test_index_file_performance(self):
        ...
        assert throughput > 200, f"File indexing throughput too low: {throughput:.2f} files/s"
    ...
    def test_registry_size_tracking(self):
        ...
        assert registry_size < 10 * 1024 * 1024, f"Registry too large: {registry_size / 1024 / 1024:.2f}MB"
