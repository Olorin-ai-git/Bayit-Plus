...
headers = {
<<<<<<< HEAD:back/tests/run_investigation_flow_for_device.py
...
try:
    ...
    # Acceptable statuses: 200 OK, 204 No Content (deleted), 404 Not Found (does not exist)
...
domain_endpoints = [
    ("device", f"{BASE_URL}/device/{device_id}"),
    ("location", f"{BASE_URL}/location/{device_id}"),
    ("network", f"{BASE_URL}/network/{device_id}"),
    ("logs", f"{BASE_URL}/logs/{device_id}"),
]
...
overall_url = f"{BASE_URL}/risk-assessment/{device_id}"
overall_params = {"investigation_id": investigation_id}
...
if not os.path.exists(font_path):
    ...
    pdf.output("investigation_summary_for_device.pdf")
    print("PDF summary saved as investigation_summary_for_device.pdf")
