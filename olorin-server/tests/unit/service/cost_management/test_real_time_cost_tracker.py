...
from app.service.cost_management.anthropic_credit_monitor import CreditStatus, CreditBalance
...
class TestRealTimeCostTracker:
    ...
    async def test_tracker_initialization(self, cost_tracker):
        ...
        expected_channels = {'cost_alerts', 'budget_status', 'optimization_stats', 'performance_metrics'}
    ...
    @pytest.mark.asyncio
    async def test_investigation_cost_tracking_workflow(self, cost_tracker, api_cost_monitor):
        """Test real-time cost tracking during investigation workflow."""
        
        # Simulate investigation phases with cost tracking
        investigation_phases = [
            {"phase": "data_extraction", "cost": 5.25, "model": "claude-3-haiku-20240307"},
            {"phase": "device_analysis", "cost": 18.50, "model": "claude-3-sonnet-20240229"},
            {"phase": "risk_assessment", "cost": 45.75, "model": "claude-opus-4-1-20250805"},
            {"phase": "report_generation", "cost": 8.25, "model": "claude-3-haiku-20240307"},
        ]
        ...
        phase_costs = [
            metric.value for name, metric in cost_tracker.current_metrics.items()
    ...
    async def test_alert_severity_escalation(self, cost_tracker):
        ...
        budget_scenarios = [
            {"usage": 400.0, "limit": 500.0, "expected_severity": AlertSeverity.WARNING},  # 80%
            {"usage": 475.0, "limit": 500.0, "expected_severity": AlertSeverity.CRITICAL}, # 95%
            {"usage": 510.0, "limit": 500.0, "expected_severity": AlertSeverity.EMERGENCY} # Over limit
        ]
    ...
    async def test_concurrent_metric_updates(self, cost_tracker):
        ...
        concurrent_metrics = [
            name for name in cost_tracker.current_metrics.keys()
    ...
    async def test_data_cleanup_functionality(self, cost_tracker):
        ...
        assert "current_metric" in cost_tracker.current_metrics # Current metric remains
    ...
    async def test_health_check_comprehensive(self, cost_tracker):
        ...
        await cost_tracker._update_metric(CostMetric(
        ...
        # Add performance history
        cost_tracker.performance_history.append(PerformanceSummary(
            total_requests=10,
...
class TestCostTrackingIntegration:
    ...
    async def test_end_to_end_investigation_tracking(self, api_cost_monitor):
        ...
        investigation_workflow = [
            {
                ...
                "metrics": [
                    {"name": "investigation_initiated", "type": MetricType.USAGE, "value": 1, "unit": "count"}
                ],
                "alerts": []
            },
            {
                ...
                "metrics": [
                    {"name": "data_collection_cost", "type": MetricType.COST, "value": 12.50, "unit": "USD"},
                    {"name": "tokens_processed", "type": MetricType.USAGE, "value": 2500, "unit": "tokens"}
                ],
                "alerts": []
            },
            {
                "step": "analysis_phase",
                "metrics": [
                    {"name": "analysis_cost", "type": MetricType.COST, "value": 35.75, "unit": "USD"},
                    {"name": "risk_score_calculated", "type": MetricType.PERFORMANCE, "value": 0.85, "unit": "score"}
                ],
                "alerts": [
                    {
            ...
            },
            {
                ...
                "metrics": [
                    {"name": "total_investigation_cost", "type": MetricType.COST, "value": 48.25, "unit": "USD"},
                    {"name": "investigation_duration", "type": MetricType.PERFORMANCE, "value": 45, "unit": "minutes"}
                ],
                "alerts": []
            }
        ]
        ...
        workflow_metrics = [
            name for name in cost_tracker.current_metrics.keys()
            if any(step in name for step in ["investigation", "data_collection", "analysis", "total"])
        ]
        ...
        workflow_alerts = [
            alert for alert in cost_tracker.active_alerts.values()
    ...
    async def test_websocket_real_time_updates(self):
        ...
        updates = [
            {"channel": "budget_status", "data": {"daily_usage": 150.0, "daily_limit": 500.0}},
            {"channel": "cost_alerts", "data": {"alert_type": "budget_warning", "severity": "warning"}},
            {"channel": "optimization_stats", "data": {"savings": 45.50, "optimization_rate": 75.0}},
            {"channel": "performance_metrics", "data": {"avg_response_time": 1.2, "success_rate": 98.5}}
        ]
    ...
    async def test_performance_monitoring_accuracy(self):
        ...
        for snapshot_data in performance_snapshots:
            summary = PerformanceSummary(
                ...
                failed_requests=snapshot_data["total_requests"] - snapshot_data["successful_requests"],
