...
def processor():
    ...
    return InvestigationDataProcessor(
        memory_limit_mb=10, batch_size=10, enable_performance_monitoring=True
    )
...
def sample_metadata():
    ...
    return {
        ...
        "status": "completed",
        "config": {"timeout": 300, "agents": ["risk_agent", "network_agent"]},
    }
    ...
    return [
        ...
        },
        {
            ...
            "data": {
                ...
                "input_parameters": {"ip": "192.168.1.100", "user_id": "user_123"},
                "output_data": {
                    "risk_score": 0.75,
        ...
        },
        {
            ...
            "data": {
                ...
                "context_data": {"risk_score": 0.75, "threat_level": "high"},
        ...
        },
        {
            ...
            "data": {
                ...
                "input_data": {"user_data": {"id": "user_123"}},
                "output_data": {"risk_assessment": "high"},
                "success": True,
            },
        },
        {
...
def sample_journey_data():
    ...
    return {
        ...
        "metadata": {"total_nodes": 5, "total_agents": 2},
    }
...
@pytest.fixture
def temp_investigation_folder(
    sample_metadata, sample_activities, sample_journey_data, sample_log_entries
):
...
class TestFileProcessing:
    ...
    def test_process_activities_file_streaming(self, processor, sample_activities):
        ...
        with tempfile.NamedTemporaryFile(mode="w", suffix=".jsonl", delete=False) as f:
            ...
            interactions_data = processor._process_activities_file_streaming(
                Path(f.name)
            )
...
class TestEndToEndProcessing:
    ...
    def test_process_complete_investigation_folder(
        self, processor, temp_investigation_folder
    ):
...
def test_create_data_processor():
    ...
    processor = create_data_processor(
        memory_limit_mb=100, batch_size=500, enable_performance_monitoring=False
    )
