...
# Test specific fraud scenario with full monitoring
./scripts/run-structured-investigation.sh --scenario device_spoofing --show-all --verbose

# Monitor LLM reasoning and WebSocket messages
./scripts/run-structured-investigation.sh --scenario impossible_travel --show-llm --show-websocket

# Full investigation visibility (ALL monitoring enabled)
./scripts/run-structured-investigation.sh --all --show-all --follow-logs --html-report
