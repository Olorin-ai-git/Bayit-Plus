...
try:
    ...
    print(f"   max_transactions_limit = {snowflake_config.get('max_transactions_limit')}")
    print(f"   Status: {'✅ PASS' if snowflake_config.get('max_transactions_limit') == '2000' else '❌ FAIL'}")
    print()
...
try:
    ...
    if database_provider == 'snowflake':
        ...
        print(f"   Status: {'✅ PASS' if str(max_transactions) == '2000' else '❌ FAIL'}")
    else:
