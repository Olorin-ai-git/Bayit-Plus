...
from ..logging_helper import RequestFormatter, _logging_request_context, logging_context
from .logging_config_manager import LoggingConfigManager
from .unified_logging_core import configure_unified_logging, get_unified_logging_core
...
class UnifiedLoggingBridge:
    ...
    def initialize_from_config(self, log_level: str = "WARNING", **kwargs) -> None:
        ...
        configure_unified_logging(log_level=log_level, **kwargs)
...
def configure_unified_bridge_from_args(
