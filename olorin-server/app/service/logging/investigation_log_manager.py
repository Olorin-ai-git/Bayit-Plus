...
from .unified_logging_core import UnifiedLoggingCore, LogFormat
...
class InvestigationLogManager:
    ...
    def start_investigation_logging(
        ...
        if not isinstance(investigation_id, str):
            raise TypeError(f"investigation_id must be a string, got {type(investigation_id)}")
        ...
        try:
            ...
            log_format = getattr(self.unified_logging_core, '_config', {}).get('log_format', LogFormat.HUMAN)
        ...
        try:
            ...
            logger.info(
                ...
                extra={
                    ...
                    'investigation_type': metadata.get('investigation_type') or metadata.get('investigationType'),
                    'lifecycle_stage': metadata.get('lifecycle_stage') or metadata.get('lifecycleStage'),
