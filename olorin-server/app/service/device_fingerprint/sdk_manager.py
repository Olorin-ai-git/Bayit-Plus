...
class SDKManager:
    ...
    def get_tenant_sdk_provider(self, tenant_id: str) -> SDKProvider:
        ...
        try:
            ...
            logger.warning(f"Failed to load SDK config for tenant {tenant_id}: {e}, using default")
    ...
    def get_sdk_config(self, tenant_id: str) -> Dict[str, Any]:
        ...
        if sdk_provider == SDKProvider.FINGERPRINT_PRO:
            config["api_key"] = self.config_loader.load_secret("FINGERPRINT_PRO_API_KEY")
    ...
    def validate_device_signal(self, device_signal: Dict[str, Any], tenant_id: str) -> bool:
        """
