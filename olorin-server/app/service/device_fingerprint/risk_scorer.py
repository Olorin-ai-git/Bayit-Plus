    ...
    def compute_device_risk_score(
        ...
        try:
            ...
            if shared_device_count > 10:
                risk_score = 0.9
                risk_factors.append(f"Device shared across {shared_device_count} accounts")
        ...
        try:
            ...
            with get_db_session() as db:
                ...
                shared_count_query = text("""
                    ...
                    LIMIT 1
                """)
                shared_result = db.execute(shared_count_query, {"device_id": device_id}).fetchone()
            ...
            return {
                ...
                "first_seen": shared_data.get("first_seen") or age_data.get("first_seen"),
