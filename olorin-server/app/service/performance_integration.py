    ...
    async def collect_metrics(self) -> PerformanceMetrics:
        ...
        try:
            ...
            if cache_manager:
                ...
                metrics.cache_hit_rate = cache_stats.get('performance', {}).get('hit_rate', 0.0)
                metrics.cache_size_mb = cache_stats.get('capacity', {}).get('total_size_bytes', 0) / 1024 / 1024
    ...
    async def initialize(self) -> Dict[str, Any]:
        ...
        try:
            ...
            result = {
                ...
                "target_improvements": {
                    "api_latency": {"target_improvement": "-40%", "target_time_ms": 200},
                    "agent_execution": {"target_improvement": "-50%", "target_time_ms": 1000},
                    "cache_hit_rate": {"target_improvement": "+200%", "target_rate": 0.85},
        ...
        try:
            ...
            result = {
                ...
                "final_metrics": {
                    ...
                    "avg_response_time_ms": sum(self.request_times[-100:]) / len(self.request_times[-100:]) if self.request_times else 0,
