...
def _include_core_routers(app: FastAPI) -> None:
    ...
    app.include_router(hybrid_graph_router, prefix="/api")  # Hybrid graph investigations (Feature 006)
    app.include_router(investigation_api_router)  # OpenAPI schema-driven investigation API (Feature 001)
    app.include_router(investigation_comparison_router)  # Investigation comparison API (Feature 001-you-editing-fraud)
