...
def example_basic_usage():
    ...
    try:
        ...
        report_path = generate_report_for_folder(
            ...
            title="Example Investigation Report"
        )
...
def example_advanced_usage():
    ...
    base_logs_dir = Path("/Users/gklainert/Documents/olorin/olorin-server/logs/investigations")
    ...
    if not folders:
        ...
        print("   Make sure investigation folders exist with the correct naming pattern.")
        return
    ...
    for i, (folder_path, metadata) in enumerate(folders[:2], 1):
        try:
            ...
            print(f"   Generating report {i}/{min(2, len(folders))} for: {investigation_id}")
