...
from ..core.data_structures import (
    ...
    JourneyTrackingData, InvestigationStatus, RiskLevel
)
...
class BaseAdapter(DataAdapter):
    ...
    def safe_extract_datetime(self, data: Dict[str, Any], key: str) -> Optional[datetime]:
        """
    ...
    def safe_extract_float(self, data: Dict[str, Any], key: str, default: float = 0.0) -> float:
        """
