...
from .data_adapter import DataAdapter, DataSourceType, AdapterRegistry
...
class UnifiedHTMLReportGenerator:
    ...
    def get_supported_data_types(self) -> List[str]:
        ...
        """
        return [adapter_info["data_type"] for adapter_info in 
                self.adapter_registry.get_registered_adapters()]
    ...
    def _adapt_data(self, data_source: Any, data_type: DataSourceType) -> UnifiedReportData:
        """
    ...
    def _generate_components(
        ...
        for component in components:
            try:
                ...
                logger.error(f"Error generating component {component.config.component_id}: {e}")
    ...
    def _generate_default_output_path(self, data: UnifiedReportData, title: str) -> Path:
