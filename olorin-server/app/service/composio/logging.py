...
def log_composio_action(action_name: str, toolkit_name: str, tenant_id: str, status: str, details: dict = None):
    """
...
def log_oauth_flow(tenant_id: str, toolkit_name: str, stage: str, success: bool, details: dict = None):
    """
