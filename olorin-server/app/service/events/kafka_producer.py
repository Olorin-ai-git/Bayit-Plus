...
class KafkaProducer:
    ...
    def __init__(self):
        ...
        if self.bootstrap_servers:
            ...
            logger.warning("Kafka bootstrap servers not configured - using batch fallback mode")
    ...
    def _initialize_producer(self) -> None:
        ...
        try:
            ...
            logger.info(f"Kafka producer initialized: bootstrap_servers={self.bootstrap_servers}")
