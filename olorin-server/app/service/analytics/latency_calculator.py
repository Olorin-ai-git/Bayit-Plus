...
class LatencyCalculator:
    ...
    def __init__(self):
        ...
        logger.info(f"LatencyCalculator initialized with {db_provider.upper()} provider")
    ...
    async def calculate_percentiles(
        ...
        investigation_col = 'INVESTIGATION_ID' if db_provider == 'snowflake' else 'investigation_id'
        ...
        logger.debug("Latency calculation skipped - MODEL_LATENCY_MS column not available in schema")
