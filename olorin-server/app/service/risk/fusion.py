...
def fuse_network_risk(internal_tx_risk: float, abuseipdb_payload: Union[str, Dict[str, Any]]) -> float:
    """
    ...
    try:
        ...
        fused_risk = (weight_internal * internal_tx_risk) + (weight_external * external_risk)
...
def fuse_domain_risks(domain_risks: Dict[str, float], weights: Dict[str, float] = None) -> float:
    """
