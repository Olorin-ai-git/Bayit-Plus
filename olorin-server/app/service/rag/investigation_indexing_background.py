...
class InvestigationIndexingBackgroundService:
    ...
    async def start(self, poll_interval_seconds: int = 60) -> None:
        ...
        logger.info(f"Started investigation indexing background service (poll interval: {poll_interval_seconds}s)")
...
def get_investigation_indexing_background_service() -> InvestigationIndexingBackgroundService:
