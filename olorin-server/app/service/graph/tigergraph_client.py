...
class TigerGraphClient:
    ...
    def _initialize_connection(self) -> None:
        ...
        try:
            ...
            logger.info(f"TigerGraph connection initialized: {self.host}/{self.graphname}")
    ...
    def create_relationship(
        ...
        try:
            ...
            logger.debug(f"Created edge: {from_type}:{from_id} -[{relationship_type}]-> {to_type}:{to_id}")
            return True
        except Exception as e:
