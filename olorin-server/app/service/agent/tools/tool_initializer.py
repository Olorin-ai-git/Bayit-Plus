            ...
            if abuseipdb_enabled:
                ...
                for tool in tools:
                    try:
                        ...
                        logger.warning(f"Failed to register AbuseIPDB tool {tool.name}: {e}")
            ...
            if virustotal_enabled:
                ...
                for tool in tools:
                    try:
                        ...
                        logger.warning(f"Failed to register VirusTotal tool {tool.name}: {e}")
            ...
            if shodan_enabled:
                ...
                for tool in tools:
                    try:
                        ...
                        logger.warning(f"Failed to register Shodan tool {tool.name}: {e}")
        ...
        try:
            ...
            for tool in tools:
                try:
                    ...
                    logger.warning(f"Failed to register blockchain tool {tool.name}: {e}")
        ...
        try:
            ...
            for tool in tools:
                try:
                    ...
                    logger.warning(f"Failed to register intelligence tool {tool.name}: {e}")
