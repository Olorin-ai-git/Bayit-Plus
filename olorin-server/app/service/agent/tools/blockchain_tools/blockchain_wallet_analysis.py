...
class BlockchainWalletAnalysisTool(BaseTool):
    ...
    def _run(
        ...
        try:
            ...
            analysis_results = {
                ...
                "transaction_analysis": self._analyze_transactions(wallet_address, network, depth),
                "compliance_check": self._check_compliance(wallet_address, include_sanctions),
                "clustering_results": self._perform_clustering(wallet_address, network) if include_clustering else None,
                "recommendations": []
            }
    ...
    def _analyze_transactions(self, address: str, network: str, depth: int) -> Dict[str, Any]:
    ...
    def _check_compliance(self, address: str, include_sanctions: bool) -> Dict[str, Any]:
