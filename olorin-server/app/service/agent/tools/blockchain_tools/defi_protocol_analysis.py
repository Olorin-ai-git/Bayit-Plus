...
class DeFiProtocolAnalysisTool(BaseTool):
    ...
    def _run(
        ...
        try:
            ...
            analysis_results = {
                ...
                "protocol_metrics": self._analyze_protocol_metrics(
                    protocol_address, protocol_type
                ),
                "transaction_analysis": self._analyze_defi_transactions(
                    protocol_address, analysis_period_hours
                ),
                "attack_detection": (
                    self._detect_defi_attacks(protocol_address)
                    if detect_attacks
                    else None
                ),
                "liquidity_analysis": (
                    self._analyze_liquidity(protocol_address)
                    if analyze_liquidity
                    else None
                ),
                "risk_assessment": {},
                "recommendations": [],
            ...
            analysis_results["risk_assessment"] = {
                ...
                "protocol_security_score": self._assess_protocol_security(
                    protocol_address
                ),
            }
    ...
    def _analyze_protocol_metrics(
        self, address: str, protocol_type: str
    ) -> Dict[str, Any]:
    ...
    def _analyze_defi_transactions(
        self, address: str, period_hours: int
    ) -> Dict[str, Any]:
