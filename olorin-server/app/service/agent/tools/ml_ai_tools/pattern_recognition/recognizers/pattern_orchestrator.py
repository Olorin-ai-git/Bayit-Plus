...
class PatternRecognizers:
    ...
    def _recognize_sequence_patterns(
        self, processed_data, minimum_support, historical_patterns
    ):
    ...
    def _recognize_behavioral_patterns(
        self, processed_data, minimum_support, historical_patterns
    ):
    ...
    def _recognize_temporal_patterns(
        self, processed_data, minimum_support, historical_patterns
    ):
    ...
    def _recognize_frequency_patterns(
        self, processed_data, minimum_support, historical_patterns
    ):
    ...
    def _recognize_network_patterns(
        self, processed_data, minimum_support, historical_patterns
    ):
    ...
    def _recognize_textual_patterns(
        self, processed_data, minimum_support, historical_patterns
    ):
