...
class RuleBasedScorer(BaseScorer):
    ...
    def score(
        ...
        if (
            assessment_scores.get("fraud", 0) > 0.7
            and assessment_scores.get("behavioral", 0) > 0.6
        ):
        ...
        if (
            assessment_scores.get("credit", 0) > 0.5
            and assessment_scores.get("operational", 0) > 0.5
        ):
