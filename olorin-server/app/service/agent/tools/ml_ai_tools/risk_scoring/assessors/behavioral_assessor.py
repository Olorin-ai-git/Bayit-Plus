...
class BehavioralRiskAssessor(BaseRiskAssessor):
    ...
    def assess(self, processed_data: Dict[str, Any], risk_tolerance: str) -> RiskAssessmentResult:
        ...
        self._assess_behavior_patterns(behavioral_data, risk_factors, contributing_factors)
        ...
        self._assess_transaction_behavior(transaction_data, risk_factors, contributing_factors)
    ...
    def _assess_transaction_behavior(
        ...
        for field, value in transaction_data.items():
            ...
            if isinstance(value, (int, float)):
                ...
                # Unusual amounts
                elif "unusual" in field_lower and "amount" in field_lower and value > 0.5:
                    risk_factors.append({
                        "score": value * 0.7,
                        "weight": 1.5,
