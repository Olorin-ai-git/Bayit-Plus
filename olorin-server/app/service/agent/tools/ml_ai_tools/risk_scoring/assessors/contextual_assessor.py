...
class ContextualRiskAssessor(BaseRiskAssessor):
    ...
    def assess(
        ...
        self._assess_geographic_risk(
            geographic_data, risk_factors, contributing_factors
        )
        ...
        self._assess_environmental_risk(
            environmental_data, risk_factors, contributing_factors
        )
