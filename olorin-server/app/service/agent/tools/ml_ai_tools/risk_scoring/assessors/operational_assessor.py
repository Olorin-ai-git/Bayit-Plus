...
class OperationalRiskAssessor(BaseRiskAssessor):
    ...
    def assess(self, processed_data: Dict[str, Any], risk_tolerance: str) -> RiskAssessmentResult:
        ...
        self._assess_process_efficiency(process_data, risk_factors, contributing_factors)

        # Analyze compliance indicators
        compliance_data = processed_data.get("compliance_data", {})
        self._assess_compliance_risk(compliance_data, risk_factors, contributing_factors)
