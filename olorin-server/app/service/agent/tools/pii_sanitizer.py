...
class PIISanitizer:
    ...
    def __init__(self):
        ...
        self.pii_patterns = {
            ...
            PIIType.BANK_ACCOUNT: [r"\b\d{8,17}\b"],  # Bank account numbers
        ...
        for pii_type in PIIType:
            ...
            for pattern in patterns:
                ...
                for match in matches:
                    ...
                    should_preserve = (
                        preserve_investigation_data
                        and self._is_investigation_relevant(
                            content, match, investigation_targets
                        )
                    )
    ...
    def _apply_sanitization(
        self, text: str, pii_type: PIIType, method: SanitizationMethod
    ) -> str:
        """
    ...
    def _tokenize_text(self, text: str, pii_type: PIIType) -> str:
        ...
        if token_key not in self._token_mapping:
            ...
            self._token_mapping[token_key] = (
                f"TOKEN_{pii_type.value.upper()}_{token_hash}"
            )

        return self._token_mapping[token_key]

    def get_sanitization_summary(
        self, detected_pii: Dict[str, List[str]]
    ) -> Dict[str, Any]:
        """
