...
class VeriphoneInput(BaseModel):
    ...
    phone: str = Field(..., description="Phone number to verify (E.164 format preferred)")
...
class VeriphoneTool(BaseTool):
    ...
    def __init__(self, **kwargs):
        ...
        try:
            ...
            logger.error(f"❌ Failed to initialize ComposioClient for VeriphoneTool: {e}")
    ...
    def _run(
        ...
        **kwargs
        ...
        logger.info(f"📞 [VeriphoneTool] Verifying phone: {phone}, entity_id: {entity_id}")
        ...
        try:
            ...
            connection_id = os.getenv("COMPOSIO_VERIPHONE_CONNECTION_ID", "veriphone-default")
