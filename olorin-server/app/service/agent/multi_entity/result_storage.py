...
from app.models.multi_entity_investigation import (
    MultiEntityInvestigationResult, MultiEntityInvestigationRequest
)
...
class MultiEntityResultStorage:
    ...
    async def store_result(
        ...
        try:
            ...
            logger.info(f"Stored result for investigation {investigation_id} "
    ...
    async def get_result(self, investigation_id: str) -> Optional[MultiEntityInvestigationResult]:
        """
    ...
    async def _cleanup_expired_results(self):
        ...
        try:
            async with self._get_connection() as conn:
                ...
                if deleted_count > 0:
                    logger.info(f"Cleaned up {deleted_count} expired investigation results")
    ...
    def _update_cache(self, investigation_id: str, result: MultiEntityInvestigationResult):
