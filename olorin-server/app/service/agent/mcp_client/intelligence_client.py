...
class IntelligenceMCPClient(BaseTool):
    ...
    def _run(self, query: str, intel_type: IntelligenceType, 
             depth: int = 2, sources: Optional[List[str]] = None) -> Dict[str, Any]:
        """
    ...
    async def _arun(self, query: str, intel_type: IntelligenceType,
                    depth: int = 2, sources: Optional[List[str]] = None) -> Dict[str, Any]:
        """
        ...
        try:
            logger.info(f"Connecting to {server_name} for {intel_type.value} intelligence")
            ...
            if intel_type == IntelligenceType.SOCIAL_MEDIA:
                results["findings"] = {
                    ...
                    "network_analysis": {
                        ...
                        "suspicious_patterns": ["rapid_follower_growth", "bot_interactions"]
                    },
    ...
    async def search_social_media(self, username: str, 
