...
async def autonomous_device_agent(state, config) -> dict:
    ...
    from .device_agent_config import (
        initialize_rag_stats, create_device_rag_config, update_rag_stats_on_success,
    ...
    journey_tracker.track_node_execution(
        ...
        input_state={"entity_id": entity_id, "device_analysis": "starting", "investigation_phase": "device_domain", "rag_enabled": RAG_AVAILABLE},
