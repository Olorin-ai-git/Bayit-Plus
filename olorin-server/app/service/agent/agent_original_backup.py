"""
Main Agent Module - Refactored fraud investigation agent system.

This module serves as the main entry point for the fraud investigation agent system,
integrating specialized modules for orchestration, investigation, and communication.
"""
...
# Import pattern-based agent system
...
# Assistant function is now imported from orchestration module
...
# _get_config_value is now imported from core module


# _rehydrate_agent_context is now imported from core module


# start_investigation is now imported from orchestration module


# Individual agent functions are now imported from investigators module
