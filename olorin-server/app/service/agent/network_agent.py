...
async def structured_network_agent(state, config) -> dict:
    ...
    from .network_agent_config import (
        create_network_agent_metadata,
        create_network_rag_config,
        get_network_objectives,
    ...
    start_metadata = create_network_agent_metadata(
    ...
    journey_tracker.track_node_execution(
        ...
        input_state={
            ...
            "investigation_phase": "network_domain",
            "rag_enabled": RAG_AVAILABLE,
        },
        output_state={
            "network_analysis": "in_progress",
            "agent_status": "active",
        ...
        agent_name=(
            "RAG-Enhanced-NetworkAgent" if RAG_AVAILABLE else "StructuredNetworkAgent"
        ),
    ...
    try:
        ...
        if MCP_ENHANCED:
            ...
            logger.info(
                "🔧 Created MCP-enhanced network agent with connection pooling, caching, and circuit breakers"
            )
            ...
            logger.info(
                "🔧 Created network agent with intelligent RAG-enhanced tool selection"
            )
        else:
        ...
        completion_metadata = create_network_agent_metadata(
        ...
        journey_tracker.track_node_execution(
            ...
            agent_name=(
                "RAG-Enhanced-NetworkAgent"
                if RAG_AVAILABLE
                else "StructuredNetworkAgent"
            ),
        ...
        error_metadata = create_network_agent_metadata(
