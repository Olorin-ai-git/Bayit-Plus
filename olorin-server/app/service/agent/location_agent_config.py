...
def update_rag_stats_on_success(rag_stats: Dict[str, Any]) -> Dict[str, Any]:
    ...
    rag_stats["domain_knowledge_categories"] = 6  # geolocation_analysis, travel_patterns, vpn_proxy_detection, timezone_analysis, location_spoofing, geographic_risk_assessment
    return rag_stats


def create_location_agent_metadata(rag_enabled: bool, rag_stats: Dict[str, Any]) -> Dict[str, Any]:
