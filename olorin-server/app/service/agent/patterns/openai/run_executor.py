...
class RunExecutor:
    ...
    async def add_messages_to_thread(self, thread_id: str, messages: List[BaseMessage]) -> None:
    ...
    async def run_assistant_with_streaming(
        ...
        try:
            ...
            if enable_streaming:
                ...
                accumulated_content, streaming_chunks = await self.streaming_handler.handle_streaming_run(
                ...
                while run.status == "requires_action":
                    function_call_count += await self.function_handler.handle_function_calls(
