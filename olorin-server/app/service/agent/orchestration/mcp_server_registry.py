...
class MCPServerRegistry:
    ...
    def __init__(self):
        ...
        self.capabilities_index: Dict[str, List[str]] = {}  # capability -> [server_names]
    ...
    def register_server(self, server_info: MCPServerInfo) -> bool:
        ...
        try:
            ...
            logger.info(f"Registered MCP server: {server_name} with {len(server_info.capabilities)} capabilities")
            return True
        ...
        try:
            ...
            for capability in server_info.capabilities:
                if capability.name in self.capabilities_index:
                    self.capabilities_index[capability.name] = [
                        s for s in self.capabilities_index[capability.name]
                        if s != server_name
                    ]
