...
def record_routing_decision(
    ...
    if safety_override and override_reason:
        ...
        clean_reasoning = [r for r in reasoning if r and r != "Safety routing without override"]
...
def get_routing_summary(state: Dict[str, Any]) -> Dict[str, Any]:
    ...
    summary = {
        ...
        "normal_routing_count": sum(1 for d in decisions if not d.get("safety_override")),
