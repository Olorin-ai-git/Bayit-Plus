...
def compute_logs_risk(tx_count: int, failures: int, error_codes: int, ext_ti: str, 
                      model_score: Optional[float] = None) -> Optional[float]:
    """
...
def compute_network_risk(is_public: bool, vpn_proxy_detected: bool, 
                        asn_reputation: str, velocity_anomaly: bool, 
                        geo_diversity: int, ext_ti: str, 
                        model_score: Optional[float] = None) -> Optional[float]:
    """
...
def compute_device_risk(device_consistency: bool, fingerprint_anomaly: bool,
                       browser_spoofing: bool, device_velocity: int,
                       ext_ti: str, model_score: Optional[float] = None) -> Optional[float]:
    """
...
def compute_location_risk(impossible_travel: bool, travel_confidence: float,
                         location_consistency: bool, high_risk_country: bool,
                         ext_ti: str, model_score: Optional[float] = None) -> Optional[float]:
    """
...
def compute_authentication_risk(failed_attempts: int, mfa_bypass: bool,
                               credential_stuffing: bool, session_anomaly: bool,
                               ext_ti: str, model_score: Optional[float] = None) -> Optional[float]:
    """
