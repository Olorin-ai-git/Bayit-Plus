...
class ToolRecommender:
    ...
    async def determine_recommended_tools(
        ...
        recommendations = self._recommend_by_strategy(
            strategy, tools_used, snowflake_data
        )
    ...
    def _recommend_high_impact_tools(
        self, tools_used: Set[str], snowflake_data: dict
    ) -> List[str]:
    ...
    def _recommend_comprehensive_tools(self, tools_used: Set[str]) -> List[str]:
        ...
        for tool in self.comprehensive_tools:
            if (
                ...
                and len(recommendations) < self.max_recommendations
            ):
