...
class AgentSelector:
    ...
    def _select_agents_by_strategy(self, strategy: InvestigationStrategy, state: HybridInvestigationState) -> List[str]:
    ...
    def _select_focused_agents(self, state: HybridInvestigationState) -> List[str]:
        ...
        priority_agents = [f"{domain}_agent" for domain in priority_domains if domain != "risk"]
    ...
    def _get_priority_domains_from_state(self, state: HybridInvestigationState) -> List[str]:
