...
class ErrorHandler:
    ...
    def handle_error(
        ...
        try:
            ...
            if self._is_circuit_breaker_open(category):
                logger.warning(f"🔌 Circuit breaker open for {category.value}, applying fallback")
    ...
    def _apply_recovery_strategy(
        ...
        if category in self.recovery_strategies:
            try:
                ...
                logger.error(f"❌ Custom recovery strategy failed: {str(strategy_error)}")
    ...
    def _recover_graph_selection_error(
        ...
        try:
            ...
            return {"success": False, "action": "recovery_failed", "error": str(recovery_error)}
