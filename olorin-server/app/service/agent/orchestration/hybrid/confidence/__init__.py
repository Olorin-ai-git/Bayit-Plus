...
class ConfidenceConsolidator:
    ...
    def consolidate_confidence_scores(
        ...
        try:
            ...
            consistency_issues = self.validator.detect_confidence_inconsistencies(confidence_values)
            
            # Calculate weighted overall confidence
            overall_confidence = self.calculator.calculate_weighted_confidence(confidence_values)
            ...
            consistency_score = self.validator.calculate_consistency_score(confidence_values)
            
            # Determine confidence level description
            level_description = self.calculator.determine_confidence_level(overall_confidence)
