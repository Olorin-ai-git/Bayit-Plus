...
class PerformanceCalculator:
    ...
    def calculate_investigation_efficiency(self, state: HybridInvestigationState) -> float:
        """
    ...
    def get_detailed_performance_metrics(self, state: HybridInvestigationState) -> Dict[str, Any]:
        """
        ...
        return {
            ...
            "safety_metrics": {
                ...
                "safety_efficiency": self._calculate_safety_efficiency(safety_overrides),
                "safety_rating": "excellent" if safety_overrides == 0 else "good" if safety_overrides <= 2 else "needs_attention"
            }
        }
