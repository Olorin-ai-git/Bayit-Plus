...
<<<<<<< HEAD
        ...
        builder.add_node("start_investigation", investigation_nodes.enhanced_start_investigation)
        builder.add_node("raw_data_node", investigation_nodes.enhanced_raw_data_node) 
        builder.add_node("fraud_investigation", investigation_nodes.enhanced_fraud_investigation)
...
>>>>>>> 001-modify-analyzer-method
        ...
        builder.add_node("ai_confidence_assessment", intelligence_nodes.ai_confidence_assessment_node)
        builder.add_node("hybrid_orchestrator", orchestrator_node.hybrid_orchestrator_node)
...
>>>>>>> 001-modify-analyzer-method
        ...
        builder.add_node("location_agent", domain_agent_enhancer.create_enhanced_domain_agent("location", location_agent_node))
...
=======
        builder.add_node("web_agent", domain_agent_enhancer.create_enhanced_domain_agent("web", web_agent_node))
        builder.add_node("merchant_agent", domain_agent_enhancer.create_enhanced_domain_agent("merchant", merchant_agent_node))
        builder.add_node("risk_agent", domain_agent_enhancer.create_enhanced_domain_agent("risk", risk_agent_node))
...
<<<<<<< HEAD
        ...
        logger.debug(f"🔧 Adding tool nodes (enhanced: {use_enhanced_tools})")
        
        # Add tool nodes based on configuration
        tool_nodes.add_tool_nodes(builder, use_enhanced_tools)
...
=======
        ...
        """Add tool execution nodes to the graph."""
        logger.debug(f"🔧 Adding tool nodes (enhanced: {use_enhanced_tools}, investigation_id: {investigation_id})")
...
>>>>>>> 001-modify-analyzer-method
    ...
    def log_node_creation_complete(self, node_count: int) -> None:
        ...
        logger.debug(f"   Intelligence mode: {self.components.get('intelligence_mode', 'adaptive')}")
        logger.debug(f"   Core nodes: investigation, intelligence, orchestration")
<<<<<<< HEAD
        logger.debug(f"   Domain agents: 6 enhanced domain agents")
=======
