...
class MemoryProvider:
    ...
    async def create_hybrid_memory(self) -> Any:
        ...
        try:
            ...
            self.memory_instance = memory
            logger.info(
                "🛡️ Using in-memory storage for hybrid graph (Redis checkpoint unavailable)"
            )
            return memory
            ...
            self.memory_instance = memory
            logger.info(
                "🛡️ Using in-memory storage for hybrid graph (Redis unavailable)"
            )
            return memory
    ...
    def get_memory_info(self) -> dict:
        ...
        return {
            ...
            "memory_instance_type": (
                type(self.memory_instance).__name__ if self.memory_instance else None
            ),
        }
