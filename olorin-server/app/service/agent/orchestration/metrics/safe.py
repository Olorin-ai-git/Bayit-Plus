...
def safe_gt(a: Optional[Union[int, float]], b: Optional[Union[int, float]], default: bool = False) -> bool:
    """
...
def safe_ratio(numerator: Optional[Union[int, float]], denominator: Optional[Union[int, float]], default: float = 0.0) -> float:
    """
