...
def safe_ratio(num: Optional[Union[int, float]], den: Optional[Union[int, float]], default: str = "N/A") -> str:
    """
...
def safe_percentage(num: Optional[Union[int, float]], den: Optional[Union[int, float]], default: str = "N/A") -> str:
    """
