...
class VerificationCache:
    ...
    def __init__(self, config: Optional[VerificationConfig] = None):
        ...
        logger.info(
            f"🗄️  Verification cache initialized - Enabled: {self.config.cache_enabled}"
        )
    ...
    async def set(
        self, key: str, verification_result: Dict[str, Any], model_used: str = "unknown"
    ) -> bool:
        """
    ...
    async def _add_to_memory(
        self, key: str, verification_result: Dict[str, Any], model_used: str
    ):
    ...
    async def _add_to_redis(self, key: str, verification_result: Dict[str, Any]):
        ...
        try:
            ...
            await self.redis_client.setex(redis_key, self.ttl_seconds, serialized)
    ...
    def get_cache_stats(self) -> Dict[str, Any]:
        ...
        redis_hit_rate = (
            (self.stats["redis_hits"] / redis_requests) if redis_requests > 0 else 0.0
        )
    ...
    def get_top_entries(self, limit: int = 10) -> List[Dict[str, Any]]:
        ...
        sorted_entries = sorted(
            self.memory_cache.values(), key=lambda e: e.access_count, reverse=True
        )
