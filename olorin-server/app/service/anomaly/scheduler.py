...
from app.service.anomaly.scheduler_jobs import (
    register_detector_jobs,
    run_detection_job
)
...
class DetectionScheduler:
    ...
    async def start(self):
        ...
        if not APSCHEDULER_AVAILABLE:
            logger.warning("APScheduler not available - scheduled detection disabled. Install with: pip install apscheduler")
            return
    ...
    async def refresh_jobs(self):
        ...
        logger.info(f"Refreshed detector jobs (removed {len(jobs_to_remove)}, added new)")
