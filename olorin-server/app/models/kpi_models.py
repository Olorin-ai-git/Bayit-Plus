...
class KPIBreakdown(Base, TimestampMixin):
    ...
    breakdown_type = Column(String, nullable=False, index=True)  # merchant, segment, method, model_version
    breakdown_value = Column(String, nullable=False, index=True)  # e.g., merchant_id, segment_name
    ...
    __table_args__ = (
        Index('idx_kpi_breakdown_pilot_type', 'pilot_id', 'breakdown_type', 'breakdown_value'),
