...
class PerformanceTrackingMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(self, request: Request, call_next: Callable) -> Response:
        ...
        if self.enable_size_tracking:
            ...
            request_info["request_size_bytes"] = (
        ...
        try:
            if perf_manager:
                ...
                async with perf_manager.track_request_performance(
    ...
    def _get_performance_manager(self):
        ...
        try:
            from ..service.performance_integration import (
    ...
    async def _log_performance_info(self, request_info: Dict[str, Any]):
        ...
        if self.enable_size_tracking:
            ...
            log_extra["response_size_bytes"] = request_info.get(
    ...
    async def _check_performance_alerts(
        self, request_info: Dict[str, Any], perf_manager: Optional[Any]
    ):
