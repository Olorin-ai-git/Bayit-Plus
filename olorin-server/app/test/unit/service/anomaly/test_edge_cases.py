...
class TestConcurrentRuns:
    ...
    def test_concurrent_runs_same_detector(self, mock_process, mock_get_cohorts, mock_detector):
...
class TestErrorConditions:
    ...
    def test_snowflake_connection_failure(self, mock_get_provider, mock_detector):
        ...
        mock_provider = Mock()
        mock_provider.connect.side_effect = ConnectionError("Snowflake connection failed")
...
class TestBoundaryConditions:
    ...
    def test_extreme_score_values(self):
        ...
        # Very high score
        severity_high = determine_severity(score=100.0, persisted_n=5, detector_params={})
