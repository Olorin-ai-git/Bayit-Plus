...
class TestCUSUMDetector:
    ...
    def test_detector_detects_level_shift(self):
        ...
        series = np.concatenate(
            [np.random.normal(100, 10, 50), np.random.normal(150, 10, 50)]  # Shift up
        )
    ...
    def test_detector_detects_negative_shift(self):
        ...
        series = np.concatenate(
            [np.random.normal(150, 10, 50), np.random.normal(100, 10, 50)]  # Shift down
        )
    ...
    def test_detector_tracks_changepoint(self):
        ...
        series = np.concatenate(
            [np.random.normal(100, 10, 50), np.random.normal(150, 10, 50)]
        )
