...
class TestAdvancedSafetyManager:
    ...
    def test_determine_safety_level_multiple_overrides(self, safety_manager, mock_state):
    ...
    def test_calculate_dynamic_limits_test_mode(self, safety_manager, mock_state):
        ...
        # Act
        limits = safety_manager._calculate_dynamic_limits(mock_state, SafetyLevel.STANDARD)
    ...
    def test_calculate_dynamic_limits_permissive_level(self, safety_manager, mock_state):
        ...
        # Act
        limits = safety_manager._calculate_dynamic_limits(mock_state, SafetyLevel.PERMISSIVE)
        
        # Assert
        # Should have increased limits due to permissive level
        standard_limits = safety_manager._calculate_dynamic_limits(mock_state, SafetyLevel.STANDARD)
    ...
    def test_calculate_dynamic_limits_strict_level(self, safety_manager, mock_state):
        ...
        # Act
        limits = safety_manager._calculate_dynamic_limits(mock_state, SafetyLevel.STRICT)
    ...
    def test_calculate_dynamic_limits_comprehensive_strategy(self, safety_manager, mock_state):
    ...
    def test_calculate_dynamic_limits_minimal_strategy(self, safety_manager, mock_state):
    ...
    def test_calculate_resource_pressure_high(self, safety_manager, mock_state):
        ...
        mock_state["tools_used"] = ["tool1", "tool2", "tool3", "tool4", "tool5", "tool6", "tool7", "tool8"]
        mock_state["domains_completed"] = ["network", "device", "location", "logs", "auth"]
    ...
    def test_identify_safety_concerns_resource_pressure(self, safety_manager, mock_state):
        ...
        # Assert
        pressure_concerns = [c for c in concerns if c.concern_type == SafetyConcernType.RESOURCE_PRESSURE]
    ...
    def test_identify_safety_concerns_confidence_drop(self, safety_manager, mock_state):
        ...
        mock_state["confidence_evolution"] = [
            {"timestamp": "2024-01-01T10:00:00", "confidence": 0.8, "trigger": "initial"},
            {"timestamp": "2024-01-01T10:05:00", "confidence": 0.4, "trigger": "update"}  # Significant drop
        ]
        ...
        # Assert
        confidence_concerns = [c for c in concerns if c.concern_type == SafetyConcernType.CONFIDENCE_DROP]
        assert len(confidence_concerns) > 0
    
    def test_identify_safety_concerns_evidence_insufficient(self, safety_manager, mock_state):
        """Test identification of insufficient evidence concerns"""
        
        # Arrange
        from app.service.agent.orchestration.hybrid.hybrid_state_schema import AIRoutingDecision, AIConfidenceLevel, InvestigationStrategy
    ...
    def test_should_allow_ai_control_high_confidence_low_pressure(self, safety_manager, mock_state):
    ...
    def test_should_allow_ai_control_critical_concerns(self, safety_manager, mock_state):
        ...
        # Act
        allows_control = safety_manager._should_allow_ai_control(mock_state, [critical_concern], 0.3)
        
        # Assert
        assert allows_control is False
    
    def test_should_allow_ai_control_medium_confidence_high_pressure(self, safety_manager, mock_state):
    ...
    def test_requires_immediate_termination_critical_concerns(self, safety_manager, mock_state):
    ...
    def test_requires_immediate_termination_loop_limit_exceeded(self, safety_manager, mock_state):
        ...
        # Act
        requires_termination = safety_manager._requires_immediate_termination(mock_state, [], limits)
        
        # Assert
        assert requires_termination is True
    
    def test_requires_immediate_termination_normal_conditions(self, safety_manager, mock_state):
    ...
    def test_build_override_reasoning(self, safety_manager, mock_state):
        ...
        # Act
        reasoning = safety_manager._build_override_reasoning(mock_state, concerns, False)
    ...
    def test_generate_recommended_actions_critical_concerns(self, safety_manager, mock_state):
        ...
        # Act
        actions = safety_manager._generate_recommended_actions(mock_state, [critical_concern], 0.9)
    ...
    def test_generate_recommended_actions_high_pressure(self, safety_manager, mock_state):
    ...
    def test_generate_recommended_actions_normal_conditions(self, safety_manager, mock_state):
