...
async def execute_agent_initialization_phase(
    investigation_id: str, request: StructuredInvestigationRequest
):
    ...
    structured_investigation_logger.log_investigation_progress(
        ...
        completed_phases=[],
        findings_summary={
            "current_phase_description": "Initializing REAL investigation agents with LangGraph"
        },
    ...
    journey_tracker.track_node_execution(
        ...
        output_state={
            ...
            "agents_to_initialize": ["device", "location", "network", "logs", "risk"],
        },
        duration_ms=0,
    ...
    agent_graph = await create_and_get_agent_graph(
        parallel=True, investigation_id=investigation_id
    )  # Hybrid graph selected by default when investigation_id is provided
    ...
    journey_tracker.track_node_execution(
        ...
        output_state={
            "phase": "agent_initialization",
            "agents_initialized": ["device", "location", "network", "logs", "risk"],
            "graph_created": True,
        },
        duration_ms=100,
...
async def execute_context_preparation_phase(
    ...
    structured_investigation_logger.log_investigation_progress(
        ...
        findings_summary={
            "current_phase_description": "Preparing REAL investigation context for agents"
        },
        risk_score_progression=[],
    ...
    journey_tracker.track_node_execution(
        ...
        output_state={
            ...
            "agent_context_created": True,
            "investigation_query": "prepared",
        },
        duration_ms=50,
        status=NodeStatus.IN_PROGRESS,
        metadata={
            "phase_type": "context_preparation",
            "query_length": len(str(investigation_context)),
        },
    )

    update_investigation_status(
        investigation_id,
        {"current_phase": "context_preparation", "progress_percentage": 15.0},
    )
