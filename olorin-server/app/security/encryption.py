...
class DataEncryption:
    ...
    def __init__(self, password: Optional[str] = None):
        ...
        self.password = password or os.getenv("ENCRYPTION_PASSWORD", "default-change-in-production")
        self.salt = os.getenv("ENCRYPTION_SALT", "default-salt-change").encode()[:16]  # Use first 16 bytes
        self._fernet = None
...
class FieldEncryption:
    ...
    def __init__(self, encryption: Optional[DataEncryption] = None):
        ...
        self.sensitive_fields = {
            "user_id", "device_id", "email", "phone", "ssn", "credit_card",
...
class RedisEncryption:
    ...
    async def set_encrypted(self, key: str, value: Union[str, dict, list], **kwargs) -> bool:
    ...
    async def hset_encrypted(self, name: str, mapping: dict) -> int:
        ...
        try:
            ...
            for field, value in mapping.items():
                if self.field_encryption.should_encrypt_field(field) and value is not None:
