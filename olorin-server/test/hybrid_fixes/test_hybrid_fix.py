#!/usr/bin/env python3
"""
Test script to validate the hybrid investigation fix
Focus: Tools condition routing fix and mock mode validation
"""
...
async def test_hybrid_tools_fix():
    """Test the hybrid investigation fix with mock mode"""
    
    print("🧪 Testing Hybrid Investigation Tools Fix")
    print("=" * 60)
    ...
    try:
        ...
        # Build graph with enhanced tools
        ...
        investigation_id = f"test_hybrid_fix_{int(datetime.now().timestamp())}"
        ...
        if tools_used > 0 and tool_results > 0:
            ...
            print("   The tools_condition routing fix is working")
        ...
        return {
            "success": tools_used > 0 and tool_results > 0,
...
if __name__ == "__main__":
    # Run the test
    result = asyncio.run(test_hybrid_tools_fix())
