...
from app.service.agent.tools.async_client_manager import (
    get_client_manager, http_session, cleanup_async_clients
)
...
def test_registry_idempotent_initialization():
    ...
    print(f"   Initial state: initialized={initial_initialized}, tools={initial_tool_count}")
    ...
    print(f"   After second init: initialized={after_second}, tools={second_tool_count}")
