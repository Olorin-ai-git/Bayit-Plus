...
async def test_hybrid_investigation_complete():
    ...
    try:
        ...
        print("⏱️ Testing complete flow: tools + enhanced processing + state management...")
        print()
        ...
        return {
            "success": all_passed,
            "core_success": success_criteria["tool_execution"] and success_criteria["tool_results"],
