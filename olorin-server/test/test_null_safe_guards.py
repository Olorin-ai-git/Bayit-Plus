...
class TestEvidenceGating:
    ...
    def test_insufficient_evidence_blocking(self):
        ...
        assert result["can_publish_numeric_risk"] == False
        assert any(
            "Insufficient evidence strength" in issue for issue in result["issues"]
        )
    ...
    def test_llm_risk_score_isolation(self):
        ...
        state = {
            "domain_findings": {
                ...
                "logs": {"llm_analysis": {"risk_score": 0.65, "confidence": 0.8}},
            }
        }
        ...
        state = {
            "domain_findings": {
                "network": {
                    ...
                    "llm_analysis": {"reasoning": "Analysis without risk score"},
                }
            }
        }
...
class TestGuardIntegration:
    ...
    def test_comprehensive_regression_prevention(self):
        ...
        assert (
            state["domain_findings"]["network"]["llm_analysis"]["claimed_risk"] == 0.90
        )
