...
def test_complete_investigation_system():
    ...
    try:
        ...
        investigation_logger.complete_investigation_logging(
            investigation_id=investigation_id, final_status="completed"
        )
        ...
        if report_file.exists():
            ...
            print(
                f"   ✅ Components found: {len(found_components)}/{len(expected_components)}"
            )
        ...
        success_criteria = [
            ...
            >= len(expected_components) * 0.8,  # 80% of components found
