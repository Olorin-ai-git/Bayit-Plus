...
export const ChaptersOverlay: React.FC<ChaptersOverlayProps> = ({
  ...
  return (
    ...
    >
      <GlassView className="flex-1 rounded-tl-3xl rounded-bl-3xl overflow-hidden" intensity="strong">
        {/* Header */}
        ...
        >
          {isLoading ? (
            <View className="flex-1 justify-center items-center py-12">
              ...
              <Text className="text-sm text-[#9ca3af] text-center">{t('chapters.generating')}</Text>
            </View>
          ) : chapters.length === 0 ? (
            <View className="flex-1 justify-center items-center py-12">
