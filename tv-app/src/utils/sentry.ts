/**
 * Sentry Error Tracking Configuration for Bayit+ tvOS App.
 *
 * Initializes Sentry SDK for React Native/tvOS with error tracking
...
/**
 * Initialize Sentry for the tvOS application.
