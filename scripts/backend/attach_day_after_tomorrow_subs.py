#!/usr/bin/env python3
"""Attach OCR'd PGS subtitles to The Day After Tomorrow (2004)."""
...
SRT_DIR = "/Users/olorin/Movies/Day After Tomorrow"
SRT_FILES = {
    "en": "title_t00.en.srt",
    "es": "title_t00.es.srt",
}
GCS_SUBS_PATH = "movies/The_Day_After_Tomorrow_2004/subtitles"
IMDB_ID = "tt0319262"
...
async def main():
    ...
    logger.info("=" * 70)
    logger.info("Attach Subtitles: The Day After Tomorrow (2004)")
    logger.info("=" * 70)
