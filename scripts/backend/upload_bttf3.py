#!/usr/bin/env python3
"""Upload Back to the Future Part III (Blu-ray) from local MKV to HLS."""
...
SOURCE_FILE = "/Users/olorin/Movies/Back to the Future Part III/Back to the Future Part III_t00.mkv"
GCS_PATH = "movies/Back_to_the_Future_Part_III/hls"
CONTENT_TITLE = "Back to the Future Part III"
IMDB_ID = "tt0099088"
...
async def convert_to_hls(input_path: str, output_dir: str) -> dict:
    ...
    cmd = [
        "ffmpeg", "-i", input_path, "-map", "0:v:0", "-map", "0:a:2",
...
async def main():
    ...
    logger.info("=" * 70)
    logger.info("Back to the Future Part III - HLS Upload Pipeline")
    logger.info("=" * 70)
    ...
    temp_dir = tempfile.mkdtemp(prefix="hls_bttf3_")
