#!/usr/bin/env python3
"""Upload Independence Day (1996) (Blu-ray) from local MKV to HLS."""
...
SOURCE_FILE = "/Users/olorin/Movies/ID4_US_V2/title_t00.mkv"
GCS_PATH = "movies/Independence_Day_1996/hls"
CONTENT_TITLE = "Independence Day"
IMDB_ID = "tt0116629"
TMDB_SEARCH = "Independence Day"
    ...
    try:
        ...
        async with httpx.AsyncClient() as client:
            response = await client.get(
                ...
                params={"api_key": api_key, "query": title, "year": 1996}, timeout=10.0,
            )
...
async def main():
    ...
    logger.info("=" * 70)
    logger.info("Independence Day (1996) - HLS Upload Pipeline")
    logger.info("=" * 70)
    ...
    temp_dir = tempfile.mkdtemp(prefix="hls_independence_day_")
    ...
    try:
        ...
        content_data = {
            ...
            "year": int(tmdb["year"]) if (tmdb and tmdb.get("year")) else 1996,
