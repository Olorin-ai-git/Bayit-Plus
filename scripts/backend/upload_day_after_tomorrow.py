#!/usr/bin/env python3
"""Upload The Day After Tomorrow (2004) (Blu-ray) from local MKV to HLS."""
...
SOURCE_FILE = "/Users/olorin/Movies/Day After Tomorrow/title_t00.mkv"
GCS_PATH = "movies/The_Day_After_Tomorrow_2004/hls"
CONTENT_TITLE = "The Day After Tomorrow"
IMDB_ID = "tt0319262"
TMDB_SEARCH = "The Day After Tomorrow"
    ...
    try:
        ...
        async with httpx.AsyncClient() as client:
            response = await client.get(
                ...
                params={"api_key": api_key, "query": title, "year": 2004}, timeout=10.0,
            )
...
async def main():
    ...
    logger.info("=" * 70)
    logger.info("The Day After Tomorrow (2004) - HLS Upload Pipeline")
    logger.info("=" * 70)
    ...
    temp_dir = tempfile.mkdtemp(prefix="hls_day_after_tomorrow_")
    ...
    try:
        ...
        content_data = {
            ...
            "year": int(tmdb["year"]) if (tmdb and tmdb.get("year")) else 2004,
