#!/usr/bin/env python3
"""Upload LOTR: The Return of the King (Extended) Part 1 from local MKV to HLS."""
...
SOURCE_FILE = "/Users/olorin/Movies/THE LORD OF THE RINGS- THE RETURN OF THE KING (EXT.) - PT.1/THE LORD OF THE RINGS- THE RETURN OF THE KING (EXT.) - PT.1_t00.mkv"
GCS_PATH = "movies/The_Lord_of_the_Rings_The_Return_of_the_King_Extended_Part_1/hls"
CONTENT_TITLE = "The Lord of the Rings: The Return of the King (Extended) - Part 1"
IMDB_ID = "tt0167260"
...
async def main():
    ...
    logger.info("=" * 70)
    logger.info("LOTR: Return of the King (Extended) Part 1 - HLS Upload Pipeline")
    logger.info("=" * 70)
    ...
    temp_dir = tempfile.mkdtemp(prefix="hls_lotr_rotk_pt1_")
