#!/usr/bin/env python3
"""Upload LOTR: The Fellowship of the Ring (Extended) Part 1 from local MKV to HLS."""
...
SOURCE_FILE = "/Users/olorin/Movies/THE LORD OF THE RINGS- THE FELLOWSHIP OF THE RING (EXT.) - PT.1/THE LORD OF THE RINGS- THE FELLOWSHIP OF THE RING (EXT.) - PT.1_t00.mkv"
GCS_PATH = "movies/The_Lord_of_the_Rings_The_Fellowship_of_the_Ring_Extended_Part_1/hls"
CONTENT_TITLE = "The Lord of the Rings: The Fellowship of the Ring (Extended) - Part 1"
IMDB_ID = "tt0120737"
...
async def main():
    ...
    logger.info("=" * 70)
    logger.info("LOTR: Fellowship of the Ring (Extended) Part 1 - HLS Upload Pipeline")
    logger.info("=" * 70)
    ...
    temp_dir = tempfile.mkdtemp(prefix="hls_lotr_fotr_pt1_")
