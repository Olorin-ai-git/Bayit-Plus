#!/usr/bin/env python3
"""Upload Back to the Future Part II (Blu-ray) from local MKV to HLS."""
...
SOURCE_FILE = "/Users/olorin/Movies/Back to the Future Part II/Back to the Future Part II_t00.mkv"
GCS_PATH = "movies/Back_to_the_Future_Part_II/hls"
CONTENT_TITLE = "Back to the Future Part II"
IMDB_ID = "tt0096874"
...
async def main():
    ...
    logger.info("=" * 70)
    logger.info("Back to the Future Part II - HLS Upload Pipeline")
    logger.info("=" * 70)
    ...
    temp_dir = tempfile.mkdtemp(prefix="hls_bttf2_")
    ...
    try:
        ...
        content_data = {
            "_id": ObjectId(), "title": tmdb["title"] if tmdb else CONTENT_TITLE,
            ...
            "year": int(tmdb["year"]) if (tmdb and tmdb.get("year")) else 1989,
