"""
Bayit+ Payments Service.

Extracted Cloud Run service for payment routes. Connects to the same
MongoDB cluster and Redis instance as the monolith, but handles only
payment endpoints with independent scaling and deployment.
"""
...
SERVICE_TITLE = "Bayit+ Payments Service"
