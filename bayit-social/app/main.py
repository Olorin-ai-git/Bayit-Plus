"""
Bayit+ Social Service.

Extracted Cloud Run service for social routes. Connects to the same
MongoDB cluster and Redis instance as the monolith, but handles only
social endpoints (friends, DMs, watch party, chess, stats) with
...
SERVICE_TITLE = "Bayit+ Social Service"
...
async def lifespan(service_app: FastAPI):
    """Service lifespan: MongoDB subset + Redis + Pub/Sub."""
