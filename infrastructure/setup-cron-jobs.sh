...
COMMON_SECRETS="${COMMON_SECRETS},TWOGATES_TASK_CLASS=bayit-twogates-task-class:latest"
COMMON_SECRETS="${COMMON_SECRETS},TWOGATES_CONNECT_TIMEOUT_SECONDS=bayit-twogates-connect-timeout-seconds:latest"
COMMON_SECRETS="${COMMON_SECRETS},TWOGATES_REQUEST_TIMEOUT_SECONDS=bayit-twogates-request-timeout-seconds:latest"
COMMON_SECRETS="${COMMON_SECRETS},TWOGATES_PROVIDER_MAX_ATTEMPTS=bayit-twogates-provider-max-attempts:latest"
COMMON_SECRETS="${COMMON_SECRETS},TWOGATES_MAX_CONNECTIONS=bayit-twogates-max-connections:latest"
COMMON_SECRETS="${COMMON_SECRETS},TWOGATES_MAX_KEEPALIVE_CONNECTIONS=bayit-twogates-max-keepalive-connections:latest"
COMMON_SECRETS="${COMMON_SECRETS},TWOGATES_KEEPALIVE_EXPIRY_SECONDS=bayit-twogates-keepalive-expiry-seconds:latest"
