...
const PricingPage: React.FC = () => {
  ...
  const comparisonFeatures = [
    { name: 'Active Stations', tiers: ['1 Station', 'Up to 5', 'Unlimited'] },
    { name: 'Content Library', tiers: ['10 GB', '100 GB', 'Unlimited'] },
    { name: 'Listener Analytics', tiers: [true, true, true] },
    { name: 'AI Scheduling', tiers: [true, true, true] },
    { name: 'Ad Insertion', tiers: [false, true, true] },
