...
const SolutionsPage: React.FC = () => {
  ...
  const industryStats: IndustryStat[] = [
    { value: s('solutionsPage.stats.retentionValue'), label: s('solutionsPage.stats.retention') },
    { value: s('solutionsPage.stats.schedulingValue'), label: s('solutionsPage.stats.scheduling') },
    { value: s('solutionsPage.stats.revenueValue'), label: s('solutionsPage.stats.revenue') },
    { value: s('solutionsPage.stats.uptimeValue'), label: s('solutionsPage.stats.uptime') },
  ];
