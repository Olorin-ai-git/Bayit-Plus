...
fun ShabbatModeRoute(
    ...
    viewModel: ShabbatModeViewModel = hiltViewModel(),
) {
    val uiState by viewModel.uiState.collectAsStateWithLifecycle()

    ShabbatModeScreen(
        uiState = uiState,
        onToggle = viewModel::toggleShabbatMode,
...
@Composable
internal fun ShabbatModeScreen(
    uiState: ShabbatModeUiState,
    onToggle: () -> Unit,
    onNavigateBack: () -> Unit,
    onRetry: () -> Unit,
    modifier: Modifier = Modifier,
    ...
    Column(modifier = modifier.fillMaxSize()) {
        ...
        when (uiState) {
            ...
            is ShabbatModeUiState.Success -> ShabbatModeContent(
                uiState = uiState,
                onToggle = onToggle,
            )

            is ShabbatModeUiState.Error -> ShabbatModeErrorContent(
...
@Composable
private fun ShabbatModeContent(
    uiState: ShabbatModeUiState.Success,
    onToggle: () -> Unit,
) {
    Column(
        modifier = Modifier
...
@Composable
private fun ShabbatModeErrorContent(
    message: String,
    onRetry: () -> Unit,
) {
    Box(
