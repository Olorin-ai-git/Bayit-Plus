...
internal fun ChildrenScreen(
    ...
    when (uiState) {
        is ChildrenUiState.Loading -> GlassLoadingIndicator(modifier = modifier)
        ...
        is ChildrenUiState.Error -> ChildrenErrorSection(
...
@Composable
private fun ChildrenErrorSection(
    message: String,
    onRetry: () -> Unit,
    modifier: Modifier = Modifier,
) {
