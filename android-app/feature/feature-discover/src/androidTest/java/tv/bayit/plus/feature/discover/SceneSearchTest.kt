...
class SceneSearchTest {
    ...
    private val feature = DiscoverFeatureCatalog.featureById("scene_search")!!

    @Test
    fun sceneSearch_isOnAndroid() {
        assert(DiscoverPlatform.ANDROID in feature.platforms)
    }

    @Test
    fun sceneSearch_notAvailable_contentType_badgeShown() {
    ...
    @Test
    fun sceneSearch_detailSheet_displaysDescription() {
        composeTestRule.setContent {
            DiscoverFeatureDetailSheet(
                feature = feature,
    ...
    @Test
    fun sceneSearch_ready_walkthroughButton_fires() {
        var started = false
