...
class TalkBackTest {
    ...
    private val feature = DiscoverFeatureCatalog.featureById("talk_back")!!

    @Test
    fun talkBack_isIosOnlyInCatalog() {
        assert(DiscoverPlatform.ANDROID !in feature.platforms)
        assert(DiscoverPlatform.IOS in feature.platforms)
    }

    @Test
    fun talkBack_platformOnly_badgeDisplayed() {
    ...
    @Test
    fun talkBack_detailSheet_displaysDescription() {
        composeTestRule.setContent {
            DiscoverFeatureDetailSheet(
                feature = feature,
                availability = FeatureAvailabilityState.PlatformOnly(DiscoverPlatform.IOS),
    ...
    @Test
    fun talkBack_platformOnly_noWalkthroughButton() {
        composeTestRule.setContent {
            DiscoverFeatureDetailSheet(
                feature = feature,
                availability = FeatureAvailabilityState.PlatformOnly(DiscoverPlatform.IOS),
