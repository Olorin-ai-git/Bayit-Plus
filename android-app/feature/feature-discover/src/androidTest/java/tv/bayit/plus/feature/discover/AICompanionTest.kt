...
class AICompanionTest {
    ...
    private val feature = DiscoverFeatureCatalog.featureById("ai_companion")!!

    @Test
    fun aiCompanion_isIosOnlyInCatalog() {
        assert(DiscoverPlatform.ANDROID !in feature.platforms)
        assert(DiscoverPlatform.IOS in feature.platforms)
    }

    @Test
    fun aiCompanion_platformOnly_badgeDisplayed() {
    ...
    @Test
    fun aiCompanion_detailSheet_displaysNameAndDescription() {
        composeTestRule.setContent {
            DiscoverFeatureDetailSheet(
                feature = feature,
                availability = FeatureAvailabilityState.PlatformOnly(DiscoverPlatform.IOS),
    ...
    @Test
    fun aiCompanion_platformOnly_noWalkthroughButton() {
        composeTestRule.setContent {
            DiscoverFeatureDetailSheet(
                feature = feature,
                availability = FeatureAvailabilityState.PlatformOnly(DiscoverPlatform.IOS),
