...
class LiveSubtitlesTest {

    @get:Rule
    val composeTestRule = createComposeRule()

    private val feature = DiscoverFeatureCatalog.featureById("live_subtitles")!!

    @Test
    fun liveSubtitles_isOnAndroid() {
        assert(DiscoverPlatform.ANDROID in feature.platforms)
    }

    @Test
    fun liveSubtitles_premiumRequired_badgeDisplayed() {
    ...
    @Test
    fun liveSubtitles_detailSheet_displaysDescription() {
        composeTestRule.setContent {
            DiscoverFeatureDetailSheet(
                feature = feature,
    ...
    @Test
    fun liveSubtitles_ready_walkthroughButton_fires() {
        var started = false
