...
class BilingualBridgeTest {

    @get:Rule
    val composeTestRule = createComposeRule()

    private val feature = DiscoverFeatureCatalog.featureById("bilingual_bridge")!!

    @Test
    fun bilingualBridge_isOnAndroid() {
        assert(DiscoverPlatform.ANDROID in feature.platforms)
    }

    @Test
    fun bilingualBridge_detailSheet_displaysDescription() {
    ...
    @Test
    fun bilingualBridge_notAvailable_contentType_badgeShown() {
        composeTestRule.setContent {
            DiscoverFeatureDetailSheet(
                feature = feature,
    ...
    @Test
    fun bilingualBridge_ready_walkthroughButton_fires() {
        var started = false
