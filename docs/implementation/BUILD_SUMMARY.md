...
**Production API URL:** `https://bayit-backend-production-624470113582.us-east1.run.app/api/v1`
...
const getApiBaseUrl = () => {
  if (!__DEV__) {
    return 'https://bayit-backend-production-624470113582.us-east1.run.app/api/v1';
  }
  // In development:
  if (Platform.OS === 'web') {
