...
**Podcasts:**
```bash
curl https://bayit-backend-production-624470113582.us-east1.run.app/api/v1/podcasts
# Returns: 5 podcasts (filtered/active)
```

**Radio Stations:**
```bash
curl https://bayit-backend-production-624470113582.us-east1.run.app/api/v1/radio
