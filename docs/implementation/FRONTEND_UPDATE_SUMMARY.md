...
**New API URL**: `https://bayit-backend-production-624470113582.us-east1.run.app/api/v1`
...
# New
VITE_API_URL=https://bayit-backend-production-624470113582.us-east1.run.app/api/v1
```
...
# New
API_BASE_URL=https://bayit-backend-production-624470113582.us-east1.run.app
```
...
4. Add: `https://bayit-backend-production-624470113582.us-east1.run.app/api/v1/auth/google/callback`
5. Click "SAVE"
...
### Backend (Cloud Run)
- ✅ Health check: `curl https://bayit-backend-production-624470113582.us-east1.run.app/health`
...
- **Backend API**: https://bayit-backend-production-624470113582.us-east1.run.app/docs
