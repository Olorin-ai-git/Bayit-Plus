...
echo '["http://localhost:3200","https://bayit-plus-web.web.app","https://bayit-backend-production-624470113582.us-east1.run.app"]' | gcloud secrets versions add bayit-cors-origins --data-file=- --project=israeli-radio-475c9
```
