...
export function useStructuredInvestigation(investigationId: string, parallel: boolean = true) {
...
2. **Missing Messages**
   ...
   - Verify the investigation is in structured mode with websocket_updates=true
