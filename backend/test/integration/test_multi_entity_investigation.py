    ...
    for i, test in enumerate(test_cases):
        ...
        try:
            parser = BooleanQueryParser(
                expression=test["expression"], entity_mapping=test["entity_mapping"]
            )
...
async def test_multi_entity_investigation():
    ...
    try:
        ...
        # Check timeline
        print(
            f"    Investigation Timeline: {len(final_result.investigation_timeline)} events"
        )
...
async def test_entity_manager():
    ...
    try:
        ...
        print(
            f"      - Relationships: {stats['manager_status']['relationships_count']}"
        )
...
async def test_cross_entity_analyzer():
    ...
    from app.service.agent.multi_entity.cross_entity_analyzer import (
        get_cross_entity_analyzer,
    )
