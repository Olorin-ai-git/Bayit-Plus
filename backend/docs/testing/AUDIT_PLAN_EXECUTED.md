...
All scripts are in `/Users/olorin/Documents/Projects/olorin/olorin-media/bayit-plus/backend/scripts/`:
...
If issues arise:
1. Check logs: `tail -f /Users/olorin/Documents/Projects/olorin/olorin-media/bayit-plus/backend/.cursor/debug.log`
