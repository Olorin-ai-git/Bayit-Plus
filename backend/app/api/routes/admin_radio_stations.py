        ...
        "items": [
            {
                ...
                "current_show": item.current_show,
...
async def get_radio_station(
    ...
    return {
        ...
        "current_show": station.current_show,
...
async def create_radio_station(
    ...
    await log_audit(
        str(current_user.id),
        AuditAction.RADIO_STATION_CREATED,
        "radio_station",
        str(station.id),
        {
            "name": station.name,
...
async def update_radio_station(
    ...
    await log_audit(
        str(current_user.id),
        AuditAction.RADIO_STATION_UPDATED,
        "radio_station",
        station_id,
        changes,
        request,
