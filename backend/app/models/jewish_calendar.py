...
US_JEWISH_CITIES = [
    USCity(name="New York", state="NY", geoname_id=5128581, latitude=40.7128, longitude=-74.0060, timezone="America/New_York"),
    USCity(name="Los Angeles", state="CA", geoname_id=5368361, latitude=34.0522, longitude=-118.2437, timezone="America/Los_Angeles"),
    USCity(name="Chicago", state="IL", geoname_id=4887398, latitude=41.8781, longitude=-87.6298, timezone="America/Chicago"),
    USCity(name="Miami", state="FL", geoname_id=4164138, latitude=25.7617, longitude=-80.1918, timezone="America/New_York"),
    USCity(name="Boston", state="MA", geoname_id=4930956, latitude=42.3601, longitude=-71.0589, timezone="America/New_York"),
    USCity(name="Philadelphia", state="PA", geoname_id=4560349, latitude=39.9526, longitude=-75.1652, timezone="America/New_York"),
    USCity(name="Atlanta", state="GA", geoname_id=4180439, latitude=33.7490, longitude=-84.3880, timezone="America/New_York"),
    USCity(name="Dallas", state="TX", geoname_id=4684888, latitude=32.7767, longitude=-96.7970, timezone="America/Chicago"),
    USCity(name="Denver", state="CO", geoname_id=5419384, latitude=39.7392, longitude=-104.9903, timezone="America/Denver"),
    USCity(name="Seattle", state="WA", geoname_id=5809844, latitude=47.6062, longitude=-122.3321, timezone="America/Los_Angeles"),
    USCity(name="Baltimore", state="MD", geoname_id=4347778, latitude=39.2904, longitude=-76.6122, timezone="America/New_York"),
    USCity(name="Cleveland", state="OH", geoname_id=5150529, latitude=41.4993, longitude=-81.6944, timezone="America/New_York"),
    USCity(name="Detroit", state="MI", geoname_id=4990729, latitude=42.3314, longitude=-83.0458, timezone="America/Detroit"),
    USCity(name="Phoenix", state="AZ", geoname_id=5308655, latitude=33.4484, longitude=-112.0740, timezone="America/Phoenix"),
    USCity(name="San Diego", state="CA", geoname_id=5391811, latitude=32.7157, longitude=-117.1611, timezone="America/Los_Angeles"),
]
