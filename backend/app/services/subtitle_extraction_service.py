        ...
        if subtitle_tracks:
            ...
            for sub in extracted:
                try:
                    ...
                    logger.info(f"✅ Extracted {sub['language']} subtitles for {content_id}")

                except Exception as e:
                    logger.error(f"Failed to save {sub['language']} subtitles: {str(e)}")
            ...
            logger.info(f"✅ Completed subtitle extraction for {content_id}: {saved_languages}")
        else:
