...
from app.services.series_linker import (  # Main service; Dataclasses; Constants; Episode matching; TMDB integration; Series creation; Duplicate resolution; Batch operations; Validation
    EPISODE_PATTERNS, DeduplicationResult, DuplicateGroup, LinkingResult,
    SeriesLinkerService, UnlinkedEpisode, auto_link_unlinked_episodes,
    auto_resolve_duplicate_episodes, create_series_from_tmdb,
    extract_series_info_from_title, find_duplicate_episodes,
    find_episodes_with_incomplete_data, find_matching_series,
    find_matching_series_by_similarity, find_series_via_tmdb,
    find_unlinked_episodes, get_series_linker_service, link_episode_to_series,
