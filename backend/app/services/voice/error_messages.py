...
ERROR_MESSAGES: Dict[str, Dict[str, str]] = {
    ...
    "playlist_add_failed": {
        "he": "מצטער, לא הצלחתי להוסיף לרשימה כרגע",
        "en": "Sorry, I couldn't add to your playlist right now",
        "es": "Lo siento, no pude agregar a tu lista ahora",
        "zh": "抱歉，无法添加到播放列表",
        "fr": "Désolé, impossible d'ajouter à votre liste",
        "it": "Mi dispiace, non sono riuscito ad aggiungere alla playlist",
        "hi": "क्षमा करें, अभी प्लेलिस्ट में नहीं जोड़ सका",
        "ta": "மன்னிக்கவும், பட்டியலில் சேர்க்க முடியவில்லை",
        "bn": "দুঃখিত, এখন প্লেলিস্টে যোগ করতে পারিনি",
        "ja": "申し訳ありません、プレイリストに追加できませんでした",
    },
    "playlist_empty": {
        "he": "הרשימה שלך ריקה",
