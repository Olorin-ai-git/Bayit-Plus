...
try:
    ...
    RATE_LIMITS = {
        ...
        "subtitle_grammar_flip": "5/hour",  # Expensive AI operations (Claude API Grammar-Flip transformation)
        "subtitle_slang_synthesis": "5/hour",  # Expensive AI operations (Claude API Slang Synthesis)
