...
_gcs_cached_sa_email: str | None = None


def _gcs_iam_sign_kwargs() -> dict:
    ...
    try:
        ...
        if _gcs_cached_sa_email is None:
            ...
            _gcs_cached_sa_email = sa_email or ""

        if not _gcs_cached_sa_email:
            return {}

        return {
            "service_account_email": _gcs_cached_sa_email,
    ...
    def get_presigned_url(self, filename: str, content_type: str) -> dict:
        ...
        try:
            try:
                ...
                sign_kwargs = _gcs_iam_sign_kwargs()
                if not sign_kwargs:
                    raise
                url = blob.generate_signed_url(
                    version="v4",
