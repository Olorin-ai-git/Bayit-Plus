...
async def test_password_strength_validation():
    ...
    try:
        ...
        print_test("Reject password without special char", False, "Should have rejected")
    except ValueError as e:
...
async def test_audit_logging_integration():
    ...
    try:
        ...
        print_test("SecurityAuditLog collection accessible", True, f"Found {count} audit logs")
...
async def test_rate_limiter_configuration():
    ...
    try:
        from app.core.rate_limiter import limiter, RATE_LIMITS, RATE_LIMITING_ENABLED
