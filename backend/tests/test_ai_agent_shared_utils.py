...
class TestContentUtils:
    ...
    async def test_get_content_or_error_success(self):
        ...
        with patch("app.services.ai_agent.executors._shared.content_utils.Content") as mock_content_class:
    ...
    async def test_get_content_section_or_error_by_id(self):
        ...
        with patch("app.services.ai_agent.executors._shared.content_utils.ContentSection") as mock_section_class:
...
class TestDryRunHandling:
    ...
    def test_handle_dry_run_active(self):
        ...
        result = handle_dry_run(True, "fix missing poster for {content_id}", content_id="123")
...
class TestActionLogging:
    ...
    async def test_log_librarian_action_basic(self):
        ...
        with patch("app.services.ai_agent.executors._shared.action_logging.LibrarianAction") as mock_action_class:
            mock_action = Mock()
