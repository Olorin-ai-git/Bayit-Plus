...
| Requisito | Minimo |
|-----------|--------|
| Version de iOS | iOS 14.0 o posterior |
| Version de iPadOS | iPadOS 14.0 o posterior |
...
| Requisito | Minimo |
|-----------|--------|
| Version de Android | Android 8.0 (Oreo) o posterior |
| RAM | 2 GB minimo |
| Almacenamiento | 100 MB libre (solo app) |
...
| Requisito | Minimo |
|-----------|--------|
| Version de tvOS | tvOS 14.0 o posterior |
...
| Requisito | Minimo |
|-----------|--------|
| Version de Android TV | Android TV 8.0 o posterior |
| RAM | 1.5 GB minimo |
...
| Apple TV 4K | 4K | Si | Si |
| Fire TV 4K | 4K | Si | Algunos modelos |
| Navegador Web | 1080p | No | No |

### Soporte de Formato de Audio

| Dispositivo | Dolby Digital | Dolby Atmos | DTS |
|-------------|---------------|-------------|-----|
| Apple TV | Si | Si | No |
...
1. Revisa la configuracion de tu dispositivo para la version del SO
2. Compara con los requisitos anteriores
3. Actualiza el SO si esta por debajo del minimo
4. Descarga Bayit+ desde tu tienda de apps
...
1. Ve a Configuracion > Sistema > Actualizacion de Software
2. Busca actualizaciones
3. Descarga e instala si esta disponible
