...
export const GlassResizablePanel: React.FC<GlassResizablePanelProps> = ({
  ...
  const panelRef = useRef<React.ElementRef<typeof View>>(null);
  ...
  if (Platform.OS !== 'web') {
    ...
    return (
      <View style={[styles.container, { width: effectiveWidth }, style]}>
        ...
        >
          <div
            style={{
              ...
              backgroundColor: isDragging ? colors.primary : colors.glassBorderLight,
