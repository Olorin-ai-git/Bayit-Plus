 ...
 * Displays list of podcast/show episodes with play, bookmark, and delete actions
 */
...
function EpisodeBookmarkButton({ episodeId }: { episodeId: string }) {
  const { t } = useTranslation();
  const { inPlaylist, handleTogglePlaylist } = useEpisodePlaylistToggle(episodeId, 'podcast');
  ...
  return (
    ...
    >
      <Bookmark
        size={16}
        color={inPlaylist ? '#a855f7' : 'rgba(156, 163, 175, 1)'}
...
const styles = StyleSheet.create({
  ...
  episodeRow: {
    ...
    padding: spacing.md, backgroundColor: 'rgba(255, 255, 255, 0.1)',
    borderRadius: borderRadius.lg, marginBottom: spacing.sm,
  },
  episodeActive: { backgroundColor: 'rgba(34, 197, 94, 0.2)', borderWidth: 1, borderColor: '#22c55e' },
  playButton: {
    width: 40, height: 40, minWidth: 40, minHeight: 40,
    justifyContent: 'center', alignItems: 'center',
    borderRadius: borderRadius.sm, backgroundColor: 'rgba(34, 197, 94, 0.1)',
  },
  episodeNumber: { width: 24, fontSize: fontSize.xs, color: 'rgba(156, 163, 175, 1)', textAlign: 'center' },
  episodeContent: { flex: 1, paddingVertical: spacing.xs, paddingHorizontal: spacing.sm },
  episodeTitle: { fontSize: fontSize.base, fontWeight: '500', color: colors.text },
  episodeDuration: { fontSize: fontSize.sm, color: 'rgba(156, 163, 175, 1)', marginTop: 2 },
  bookmarkButton: {
    width: 40, height: 40, minWidth: 40, minHeight: 40,
    justifyContent: 'center', alignItems: 'center',
    borderRadius: borderRadius.sm, backgroundColor: 'rgba(168, 85, 247, 0.1)',
  },
  deleteButton: {
    width: 40, height: 40, minWidth: 40, minHeight: 40,
    justifyContent: 'center', alignItems: 'center',
    borderRadius: borderRadius.sm, backgroundColor: 'rgba(239, 68, 68, 0.1)',
  },
});
