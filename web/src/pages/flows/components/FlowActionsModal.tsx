/**
 * FlowActionsModal Component
 * Modal that replaces the sidebar with flow actions and templates
 */

import React, { useState } from 'react';
import { View, Text, StyleSheet, Pressable, ScrollView } from 'react-native';
import { useTranslation } from 'react-i18next';
import { Plus, Play, Edit2, Trash2, Sparkles, Sun, Moon, Coffee, Sunset, Star, X } from 'lucide-react';
...
interface FlowActionsModalProps {
  visible: boolean;
...
export function FlowActionsModal({
  visible,
  selectedFlow,
  isRTL = false,
  onClose,
  ...
  return (
    ...
    >
      <ScrollView style={styles.scroll} contentContainerStyle={styles.content}>
        {/* Create New Flow */}
        <Pressable style={[styles.action, isRTL && styles.actionRTL]} onPress={() => { onCreateFlow(); onClose(); }}>
        ...
        <View style={styles.examplesGrid}>
          {EXAMPLE_FLOWS.map((example) => (
            <Pressable
              ...
              onPress={() => { onUseTemplate?.(example.template); onClose(); }}
        ...
        {selectedFlow && (
          <>
            ...
            <Pressable style={[styles.action, isRTL && styles.actionRTL]} onPress={() => { onStartFlow(); onClose(); }}>
            ...
            {selectedFlow.flow_type === 'custom' && (
              <>
                <Pressable style={[styles.action, isRTL && styles.actionRTL]} onPress={() => { onEditFlow(); onClose(); }}>
                  <View style={styles.actionIcon}>
                ...
                <Pressable style={[styles.action, isRTL && styles.actionRTL]} onPress={() => { onDeleteFlow(); onClose(); }}>
