      ...
      <View style={styles.overlay}>
        <View style={styles.modal}>
          ...
          <ScrollView style={styles.scrollView}>
            <GlassInput label={t('admin.audiobooks.form.title', 'Title')} placeholder={t('admin.audiobooks.form.titlePlaceholder', 'Audiobook title')} value={formData.title} onChangeText={(title: string) => setFormData(p => ({ ...p, title }))} containerStyle={styles.input} />
            <GlassInput label={t('admin.audiobooks.form.author', 'Author')} placeholder={t('admin.audiobooks.form.authorPlaceholder', 'Author name')} value={formData.author} onChangeText={(author: string) => setFormData(p => ({ ...p, author }))} containerStyle={styles.input} />
            <GlassInput label={t('admin.audiobooks.form.narrator', 'Narrator')} placeholder={t('admin.audiobooks.form.narratorPlaceholder', 'Narrator name')} value={formData.narrator} onChangeText={(narrator: string) => setFormData(p => ({ ...p, narrator }))} containerStyle={styles.input} />
            <GlassInput label={t('admin.audiobooks.form.description', 'Description')} placeholder={t('admin.audiobooks.form.descriptionPlaceholder', 'Audiobook description')} value={formData.description} onChangeText={(description: string) => setFormData(p => ({ ...p, description }))} containerStyle={styles.input} multiline />
            <GlassInput label={t('admin.audiobooks.form.duration', 'Duration')} placeholder={t('admin.audiobooks.form.durationPlaceholder', 'HH:MM:SS')} value={formData.duration} onChangeText={(duration: string) => setFormData(p => ({ ...p, duration }))} containerStyle={styles.input} />
            <GlassSelect label={t('admin.audiobooks.form.quality', 'Audio Quality')} options={AUDIO_QUALITIES.map(q => ({ label: q, value: q }))} value={formData.quality} onChange={(quality: string) => setFormData(p => ({ ...p, quality }))} containerStyle={styles.input} />
            <GlassInput label={t('admin.audiobooks.form.isbn', 'ISBN')} placeholder={t('admin.audiobooks.form.isbnPlaceholder', 'ISBN number')} value={formData.isbn} onChangeText={(isbn: string) => setFormData(p => ({ ...p, isbn }))} containerStyle={styles.input} />
            <GlassInput label={t('admin.audiobooks.form.publisher', 'Publisher')} placeholder={t('admin.audiobooks.form.publisherPlaceholder', 'Publisher name')} value={formData.publisher} onChangeText={(publisher: string) => setFormData(p => ({ ...p, publisher }))} containerStyle={styles.input} />
            <GlassSelect label={t('admin.audiobooks.form.subscription', 'Subscription Tier')} options={SUBSCRIPTION_TIERS.map(tier => ({ label: tier, value: tier }))} value={formData.subscription_tier} onChange={(subscription_tier: string) => setFormData(p => ({ ...p, subscription_tier }))} containerStyle={styles.input} />
            <GlassInput label={t('admin.audiobooks.form.streamUrl', 'Stream URL')} placeholder={t('admin.audiobooks.form.streamUrlPlaceholder', 'https://...')} value={formData.stream_url} onChangeText={(stream_url: string) => setFormData(p => ({ ...p, stream_url }))} containerStyle={styles.input} />
          </ScrollView>
