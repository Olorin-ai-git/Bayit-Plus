...
export function SeriesHero({
  ...
  const backdropUrl =
    selectedEpisode?.thumbnail || series.backdrop || series.thumbnail;
        ...
        <View style={[styles.metadataRow, { flexDirection }]}>
          ...
          {(series.total_seasons > 0 ||
            ...
            <Text style={styles.metadataText}>
              {series.total_seasons || series.seasons?.length || 1}{" "}
              {t("content.seasons")}
            </Text>
          )}
          ...
          {series.available_subtitles &&
            series.available_subtitles.length > 0 && (
