...
function DownloadCard({ item, onDelete }: { item: DownloadItem; onDelete: (id: string) => void }) {
          ...
          <View style={styles.thumbnailContainer}>
            ...
            {(isDownloading || isPaused) && (
              <View style={styles.statusOverlay}>
                ...
                {isPaused && <Text style={styles.pausedText}>מושהה</Text>}
              </View>
            )}
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <View style={{ flex: 1, maxWidth: `${100 / numColumns}%` }}>
              <DownloadCard item={item} onDelete={handleDelete} />
            </View>
          )}
        />
      ) : (
