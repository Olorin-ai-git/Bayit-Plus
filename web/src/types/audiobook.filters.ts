...
export const AudiobookFiltersSchema = z.object({
  ...
  page_size: z.number().int().min(1).max(500).default(20),
...
export type AudiobookSearchSuggestion = z.infer<
  typeof AudiobookSearchSuggestionSchema
>;
export type AudiobookSearchResponse = z.infer<
  typeof AudiobookSearchResponseSchema
>;
