...
export default function RightControls({
    ...
    return (
      ...
      >
        ...
        <GlassLiveControlsPanel
          ...
          renderChannelChatButton={
            !responsive.isMobile ? renderChannelChatButton : undefined
          }
          renderLiveTriviaButton={
            !responsive.isMobile ? renderLiveTriviaButton : undefined
          }
  ...
  return (
    ...
    >
      ...
      {/* VOD interaction navigation buttons (non-live only) */}
      {!isLive &&
        renderPreviousInteractionButton &&
        renderPreviousInteractionButton()}
