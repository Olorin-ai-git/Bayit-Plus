...
export default function SettingsPanel({
  ...
  return (
    <GlassView style={styles.panel} onClick={(e: any) => e.stopPropagation()}>
      ...
      <View style={styles.content}>
            ...
            <View style={styles.section}>
              ...
              <View style={styles.optionsList}>
                {availableSubtitleLanguages.map((langCode) => {
                  ...
                  const isIconName =
                    lang.icon === "synagogue" || lang.icon === "globe";
                  return (
                    <Pressable
                      key={langCode}
                      style={[
              ...
              availableQualities.map((quality) => {
                ...
                return (
                  <Pressable
                    ...
                    style={[styles.optionFull, isActive && styles.optionActive]}
        ...
        {onOpenSleepTimer && (
          <View style={styles.section}>
            <Pressable style={styles.optionFull} onPress={onOpenSleepTimer}>
        ...
        {!isLive && onOpenSubtitlesSearch && (
          <View style={styles.section}>
            <Pressable
              style={styles.optionFull}
              onPress={onOpenSubtitlesSearch}
            >
              <Text style={styles.optionText}>
