...
const EPGRecordingIndicator: React.FC<EPGRecordingIndicatorProps> = ({
  ...
  return (
    <View style={styles.container}>
      {status === "scheduled" && (
        <View
          style={[styles.badge, styles.badgeScheduled, sizeStyle]}
          title={t("epg.recording.scheduled")}
        >
      ...
      {status === "active" && (
        <View
          style={[styles.badge, styles.badgeActive, sizeStyle]}
          title={t("epg.recording.active")}
        >
      ...
      {status === "completed" && (
        <View
          style={[styles.badge, styles.badgeCompleted, sizeStyle]}
          title={t("epg.recording.completed")}
        >
      ...
      {status === "series" && (
        <View
          style={[styles.badge, styles.badgeSeries, sizeStyle]}
          title={t("epg.recording.series")}
        >
