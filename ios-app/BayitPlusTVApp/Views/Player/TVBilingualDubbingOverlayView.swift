...
struct TVBilingualDubbingOverlayView: View {
    ...
    private var dubbingToggle: some View {
        GlassButton(
            viewModel.isActive ? "Bilingual Bridge On" : "Bilingual Bridge Off",
        ...
        .accessibilityValue(viewModel.isActive ? "Enabled" : "Disabled")
        .accessibilityHint("Press select to toggle bilingual dubbing")
    }
    ...
    private var statusRow: some View {
        if let proficiency = viewModel.proficiency {
            HStack(spacing: TVDesignTokens.Spacing.md) {
                ...
                // Session indicator
                if viewModel.isActive {
                    GlassBadge(text: "Active", variant: .success)
