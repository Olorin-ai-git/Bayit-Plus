    ...
    struct TVStreamLimitExceededView: View {
        ...
        var body: some View {
            VStack(spacing: TVDesignTokens.Spacing.xl) {
                ...
                GlassButton(localization.t("common.close"), variant: .ghost, size: .large) { onDismiss() }
                    .tvFocusStyle()
            }
                ...
                ForEach(activeDevices) { device in
                    HStack(spacing: TVDesignTokens.Spacing.lg) {
                        ...
                        VStack(alignment: .leading, spacing: TVDesignTokens.Spacing.xs) {
                            Text(device.name ?? localization.t("player.unknownDevice"))
                        ...
                        GlassButton(localization.t("player.disconnect"), variant: .secondary, size: .medium) {
