    ...
    struct TVPartyMemberRowView: View {
        ...
        private var statusText: String {
            if participant.isSpeaking {
                return localization.t("watchParty.status.speaking")
            } else if participant.isMuted {
                return localization.t("watchParty.status.muted")
            } else {
                return localization.t("watchParty.status.ready")
            }
        }
    ...
    private struct HostBadge: View {
        @Environment(LocalizationManager.self) private var localization
        var body: some View {
            Text(localization.t("watchParty.host"))
