        ...
        var body: some View {
            VStack(spacing: TVDesignTokens.Spacing.xl) {
                ...
                HStack(spacing: TVDesignTokens.Spacing.lg) {
                    if !showResult {
                        GlassButton(localization.t("common.submit"), variant: .primary, size: .large) {
                            submitAnswer()
                        }
                        .tvFocusStyle()
                    ...
                    GlassButton(localization.t("common.skip"), variant: .ghost, size: .large) {
                        onDismiss()
                    }
                    .tvFocusStyle()
                }
        ...
        private var resultFeedback: some View {
            if let selected = selectedIndex {
                ...
                HStack(spacing: TVDesignTokens.Spacing.md) {
                    ...
                    Text(isCorrect ? localization.t("trivia.correct") : localization.t("trivia.notQuite"))
