...
/// Radio content tab within the Listen screen - station grid with live playback
struct RadioListenTab: View {
    ...
    private func stationGrid(_ stations: [RadioStationItem]) -> some View {
        LazyVGrid(columns: columns, spacing: DesignTokens.Spacing.md) {
            ForEach(stations) { station in
                ...
                RadioStationCard(station: station, isActive: isActive) {
...
/// Individual radio station card for the Listen tab grid
