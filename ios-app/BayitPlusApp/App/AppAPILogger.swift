...
/// Bridges `BayitCore.BayitLogger` → `BayitNetworking.APILogger`.
///
/// Lives in the host app target to keep BayitCore and BayitNetworking
/// decoupled from each other.
struct AppAPILogger: APILogger {
