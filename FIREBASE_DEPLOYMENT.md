...
echo '["http://localhost:3000","https://bayit-plus-web.web.app","https://bayit-plus-backend-534446777606.us-east1.run.app"]' | gcloud secrets versions add bayit-cors-origins --data-file=- --project=israeli-radio-475c9
```
