...
**Feature Branch**: `026-realtime-flow-dashboard`  
**Created**: 2025-12-26  
**Status**: Draft  
...
- **FR-008**: The Daily Flow Progression panel MUST summarize the “daily flow” as all investigations created on the current UTC day, derived from persisted investigation state.
- **FR-009**: The Monthly Flow Progression panel MUST summarize “month-to-date flow” as all investigations created in the current UTC month, derived from persisted investigation state, including a per-day breakdown where data exists.
