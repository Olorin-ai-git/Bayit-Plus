...
- **[backend-architect](engineering/backend-architect.md)** - Design RESTful APIs, microservice boundaries, and database schemas
- **[frontend-developer](engineering/frontend-developer.md)** - Build React components, implement responsive layouts, and handle client-side state management
- **[ui-ux-designer](ui-ux-designer.md)** - Create interface designs, wireframes, and design systems
- **[mobile-developer](frontend/mobile-developer.md)** - Develop React Native or Flutter apps with native integrations
...
- **[devops-troubleshooter](infrastructure/devops-troubleshooter.md)** - Debug production issues, analyze logs, and fix deployment failures
...
- **[database-admin](infrastructure/database-admin.md)** - Manage database operations, backups, replication, and monitoring
- **[terraform-specialist](infrastructure/terraform-specialist.md)** - Write advanced Terraform modules, manage state files, and implement IaC best practices
- **[incident-responder](infrastructure/incident-responder.md)** - Handles production incidents with urgency and precision
- **[network-engineer](infrastructure/network-engineer.md)** - Debug network connectivity, configure load balancers, and analyze traffic patterns
- **[dx-optimizer](dx-optimizer.md)** - Developer Experience specialist that improves tooling, setup, and workflows

### Quality & Security
- **[code-reviewer](universal/code-reviewer.md)** - Expert code review with deep configuration security focus and production reliability
- **[security-auditor](security/CONSOLIDATED_SECURITY_AUDITOR.md)** - Review code for vulnerabilities and ensure OWASP compliance
...
- **[error-detective](ai-analysis/error-detective.md)** - Search logs and codebases for error patterns, stack traces, and anomalies
...
- **[data-engineer](data/data-engineer.md)** - Build ETL pipelines, data warehouses, and streaming architectures
- **[ai-engineer](engineering/ai-engineer.md)** - Build LLM applications, RAG systems, and prompt pipelines
...
### Business & Marketing
- **[business-analyst](business/business-analyst.md)** - Analyze metrics, create reports, and track KPIs
