...
3. 🛑 **MANDATORY PLAN APPROVAL: Never implement ANY plan without explicit user approval - EVER!**
...
4. 🔍 **CRITICAL: MANDATORY CODEBASE ANALYSIS BEFORE ANY PLAN CREATION - NEVER SKIP!**
...
5. 🧠 **MANDATORY: Always use global subagents for ALL tasks.**
...
6. 📋 **Always generate a TodoList before you begin.**
...
7. 📊 **Use model OpusPlan (Opus 4.1) for planning and task breakdown.**
   - Invoke OpusPlan to:
...
8. ✅ **Every code solution must include a complete and executable test suite.**
   - Test suites must be:
...
9. 🔁 **If any test fails, fix iteratively with a dedicated subagent.**
...
10. 🔁 **If there are TypeScript or Python errors (e.g., type-checking, compile-time errors), resolve them iteratively.**
...
11. 🔍 **ALWAYS USE code-reviewer subagent AS A FINAL STEP OF ANY IMPLEMENTATION TASK.**
...
12. 🏗️ **AFTER completing a coding task, you MUST build the project and iteratively fix any build errors.**
...
13. 🔀 **MANDATORY: ALL git operations MUST be handled by the git-expert subagent.**
...
16. ✅**Python environment**: Always use Poetry commands for Python projects. Only Python 3.11 is supported
      - **Never use pip or python directly** - All Python commands must go through Poetry (e.g., `poetry run python`)

17. ✅   **All css must be using Tailwind css** 
      - Do NOT use material ui.   

18. ✅ **All production code files MUST have less than 200 lines of code.**
...
19. ✅ **Use centralized MCP server configuration for all projects.**
...
20. ✅ **Use centralized subagent configuration for all projects.**
...
21. ✅ **Use centralized scripts library for all projects.**
...
22. ✅ **Use centralized documentation library for all projects.**
...
23. ✅ **MANDATORY: Run MCP setup script for every new project.**
...
24. 📊 **MANDATORY: Always create a plan with model Opus 4.1 BEFORE writing any code for ANY task.**
...
25. 🚀 **MANDATORY: Always use deployment subagents for Firebase deployments.**
...
26. 🎛️ **MANDATORY: Orchestrator Task Flow Control for Coding Plans and Designs.**
