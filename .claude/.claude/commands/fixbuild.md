...
Universal build error resolution system for modular project architectures. Iteratively runs build processes across root repository and all git submodules, using specialized agents to identify, analyze, and fix ALL build errors until successful compilation is achieved.

**Project Support**: Works with any project that implements the fixbuild architecture, with specialized support for CVPlus modular architecture.
