...
Extracted Cloud Run service for authentication routes. Connects to the same
MongoDB cluster and Redis instance as the monolith, but handles only
auth endpoints with independent scaling and deployment.
"""
...
SERVICE_TITLE = "Bayit+ Auth Service"
